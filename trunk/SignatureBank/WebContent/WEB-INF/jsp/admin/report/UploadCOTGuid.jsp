...
<h1>Component Only Table Guid Upload</h1>
<br>
<p>Utilize this loader to load Component Only Table. COT is the outcome from SWKBT to Sigbank.</p>
...
<html:form action="/UploadCOTGuidSave" enctype="multipart/form-data">
