...
<br />
<s:form action="showBreakConfirmation" namespace="/account/recon"
	theme="simple">
	<div class="float-left" style="width:25%;"><label for="runon">Run
	on:</label></div>
	<div class="float-left" style="width:75%;"><s:select name="runon"
		label="Run on"
...
<div class="hrule-dots"></div>
<div class="clear"></div>
<small> <display:table name="list" class="basic-table" summary="Break Recon"
