...
<s:form action="applyManualRecon" namespace="/account/recon"
	...
	<div class="float-left" style="width: 75%;"><s:property
		value="maxLicenses" default="N/A" /></div>
	...
	<div class="hrule-dots"></div>
	<div class="clear"></div>
	<small> <display:table name="data.list" class="basic-table" summary="alert list"
	...
	<display:table name="licenseList" class="basic-table" id="row" summary="license list"
		...
		<display:column property="productName" title="Product name"
			href="/TRAILS/account/license/licenseDetails.htm" paramId="licenseId"
			paramProperty="id" />
