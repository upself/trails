...
<br />
<p>Choose which systems to mark as pending customer decision and whether or not
to overwrite both manual and automated reconciliations that have the selected
software products shown in the list below. When you are finished, click on the
"Next" button to be taken to a confirmation page. Click on cancel to return to
the workspace.</p>
<br />
...
<s:form action="showPendingCustomerDecisionConfirmation"
	namespace="/account/recon" theme="simple">
...
<div class="hrule-dots"></div>
<div class="clear"></div>
<small><display:table name="list" class="basic-table" summary="pending Customer Decision" id="row" cellspacing="1"
	cellpadding="0">
