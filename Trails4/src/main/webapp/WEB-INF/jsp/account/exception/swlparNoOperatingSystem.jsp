...
<h1>Active SW LPAR without Operating System:<s:property
...
<s:if test="%{data.list.size>0}">
	...
	<br />The data exception exists because
    <br />(1) there is no operating system in the scan data or 
    <br />(2) operating system is listed below because there is no signature or filter in Signature Bank that matches the operating system from the scan
	...
	<s:form action="swlparNOOS" method="post" theme="simple">
		...
		<display:table name="data" class="basic-table" id="row"
			summary="SoftwareLpar NO Operating System"
			decorator="org.displaytag.decorator.TotalTableDecorator"
			cellspacing="2" cellpadding="0" requestURI="swlparNOOS.htm">
	...
	<div id="popupDl" class="hideDlg" style=""><s:form id="swlparNOOS_1" theme="simple">
