...
<div class="callout">
<h2 class="bar-green-med-light"><span class="style3">Account
alerts</span></h2>
<sx:div href="%{#alertUrl}?type=ALERT" cssClass="table-wrap" delay="200" loadingText="Loading..." showLoadingText="true" >
</sx:div> <br />
<br />
<h2 class="bar-green-med-light"><span class="style3">Account
exceptions</span></h2>
