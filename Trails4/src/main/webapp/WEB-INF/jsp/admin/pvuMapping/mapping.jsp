...
<s:form action="updatePvuMap" method="post"
	...
	<div class="map_result_title"><div class="label">Mapped asset machine model</div> 
	    ...
	    <s:select
		name="mapped_model_hide_select" list="selectedProcessorModels" 
		cssClass="map_hidden" id="mapped_model_hide_select" size="10"
		multiple="true"></s:select><select class="map_items"
		id="mapped_model_select" size="10" multiple="multiple"></select></div></div>
