...
public class DataExceptionTypeDaoJpa extends
        AbstractGenericEntityDAOJpa<DataExceptionType, Long> implements
        DataExceptionTypeDao {

    public DataExceptionType findWithCauses(Long plId) {
        return (DataExceptionType) entityManager
                .createNamedQuery("findAlertTypeById").setParameter("id", plId)
                .getSingleResult();
    }

    public DataExceptionType getAlertTypeByCode(String code) {
        return (DataExceptionType) entityManager
