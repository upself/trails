...
<html lang="en">
<head>
	<title>Bravo Hostnames Error: <c:out value="${account.customer.accountNumber}"/></title>
...
<!-- START CONTENT HERE -->
		...
		<h1>Hostnames Error: <font color="RED"><c:out value="${account.customer.accountNumber}"/></font></h1>
