...
<title><c:out value="${hardware.action}" /> Hardware: <c:out
		value="${hardware.lparName}" /></title>
				...
				<div id="ibm-leadspace-head" class="ibm-alternate">
					<div id="ibm-leadspace-body">
						...
						<p id="breadcrumbs">
							...
							<c:choose>
								<c:when
									test="${hardware.lparName == null || hardware.lparName == ''}">
									&gt;
									<html:link
														page="/hardware/lpar/create.do?accountId=${account.customer.accountNumber}">
										LPAR Create
									</html:link>
												</c:when>
									...
									&gt;
									<html:link
														page="/lpar/view.do?accountId=${account.customer.accountNumber}&lparName=${hardware.lparName}">
									...
									&gt;
									<html:link
														page="/hardware/lpar/create.do?accountId=${account.customer.accountNumber}&lparName=${hardware.lparName}">
										LPAR Create
									</html:link>
								</c:when>
								<c:otherwise>
						...
						<h1>
							<c:out value="${hardware.action}" />
							Hardware: <font class="green-dark"> <c:out
									...
									<table border="0" width="80%" cellspacing="10" cellpadding="0">
										<tbody>
											<tr>
												...
												<td><html:text property="lparName"
														styleClass="ibm-styled"
														readonly="${hardware.readOnly['lparName']}" /></td>
												<td class="error"><html:errors property="lparName" /></td>
											</tr>
											<tr>
												<td nowrap="nowrap">Machine Type:</td>
												<td><html:text property="machineType"
														styleClass="ibm-styled"
														readonly="${hardware.readOnly['machineType']}" /></td>
												<td class="error"><html:errors property="machineType" /></td>
											</tr>
											<tr>
												<td nowrap="nowrap">Serial:</td>
												<td><html:text property="serial"
														styleClass="ibm-styled"
														readonly="${hardware.readOnly['serial']}" /></td>
