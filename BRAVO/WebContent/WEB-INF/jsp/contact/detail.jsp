									...
									<tbody>
										<tr>
											<td><font class="orange-dark"> <c:out
													value="${contact.contact.id}" /></font></td>
											<td><font class="orange-dark"> <c:out
													value="${contact.contact.name}" /></font></td>
											<td><font class="orange-dark"> <c:out
													value="${contact.contact.email}" /></font></td>
											<td><font class="orange-dark"> <c:out
													value="${contact.contact.serial}" /></font></td>
											<td><font class="orange-dark"> <c:out
													value="${contact.contact.serialMgr1}" /></font></td>
											<td><font class="orange-dark"> <c:out
													value="${contact.contact.serialMgr2}" /></font></td>
											<td><font class="orange-dark"> <c:out
													value="${contact.contact.serialMgr3}" /></font></td>
											<td><font class="orange-dark"> <c:out
													value="${contact.contact.isManager}" /></font></td>
										</tr>
									</tbody>
								</table>
									...
									<div class="ibm-container-body">
										<ul class="ibm-link-list">
											...
											<li><a class="ibm-forward-link"
												href="/BRAVO/contact/refresh.do?accountId=${accountId}&lparName=${lparName}&context=ACCOUNT&id=${contact.contact.id}&customerid=${contact.customer.customerId}&email=${contact.contact.email}">Refresh
													Contact Information from Blue Pages</a></li>
								...
								<div class="ibm-container">
									...
									<div class="ibm-container-body">
										<ul class="ibm-link-list">
											...
											<!-- Refresh Contact -->
											<li><a class="ibm-forward-link"
												href="/BRAVO/contact/refresh.do?accountId=${accountId}&lparName=${lparName}&context=HDW&id=${contact.contact.id}&customerid=${customerId}&email=${contact.contact.email}">Refresh
													Contact Information from Blue Pages</a></li>
								...
								<div class="ibm-container">
									...
									<div class="ibm-container-body">
										<ul class="ibm-link-list">
											...
											<!-- Refresh Contact -->
											<li><a class="ibm-forward-link"
												href="/BRAVO/contact/refresh.do?accountId=${accountId}&lparName=${lparName}&context=LPAR&id=${contact.contact.id}&customerid=${customerId}&email=${contact.contact.email}">Refresh
													Contact Information from Blue Pages</a></li>
