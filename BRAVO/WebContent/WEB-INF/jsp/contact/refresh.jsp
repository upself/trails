							...
							<div class="ibm-col-1-1">
								...
								<ul class="ibm-link-list">
									...
									<li><a class="ibm-forward-link"
										href="/BRAVO/contact/refresh.do?lparName=${lparName}&accountId=${accountId}&context=${context}&id=&customerid=${customerid}&email=">Refresh
											All Existing Contacts from Blue Pages</a></li>


									<li><a class="ibm-add1-link"
										href="/BRAVO/contact/create.do?lparName=${lparName}&accountId=${accountId}&context=${context}&id=&customerid=${customerid}&email=">Add
											<c:out value="${context}" /> Contact
									</a></li>
								...
								<div class="indent">
									<h3>Click on Icon to Remove from Contact List</h3>
								</div>
								<display:table name="contactList" requestURI=""
									...
									<display:column value="${imageTag}" title=""
										href="/BRAVO/contact/edit.do?lparName=${lparName}&accountId=${accountId}&context=${context}&customerid=${customerid}"
										paramId="id" paramProperty="contact.id" headerClass="blue-med" />
									<display:column property="contact.id" title="ID"
										headerClass="blue-med" />
									<display:column property="contact.name" title="NAME"
										headerClass="blue-med" />
									<display:column property="contact.serial" title="SERIAL"
										headerClass="blue-med" />
									<display:column property="contact.serialMgr1"
										title="1st Line Mgr" headerClass="blue-med" />
									<display:column property="contact.serialMgr2"
										title="2nd Line Mgr" headerClass="blue-med" />
									<display:column property="contact.serialMgr3"
										title="3rd Line Mgr" headerClass="blue-med" />
									<display:column property="contact.isManager" title="Is Manager"
										headerClass="blue-med" />
								</display:table>
