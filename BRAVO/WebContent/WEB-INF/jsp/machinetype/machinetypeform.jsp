									...
									<table border="0" width="80%" cellspacing="10" cellpadding="0">
										<tbody>
											...
											<tr>
												...
												<td nowrap="nowrap"><html:text property="name"
														styleClass="input" value="${machineType.name}"
														disabled="${machineType.locked}" /></td>
											</tr>
											<tr>
												<th>Definition:</th>
												<td nowrap="nowrap"><html:textarea
														property="definition" rows="4" cols="60"
														styleClass="input" value="${machineType.definition}" /></td>
											</tr>
											<tr>
												<th>Type:</th>
												<td nowrap="nowrap"><html:select property="type">
														<html:options name="machineTypeListType" />
													</html:select></td>
											</tr>
											<tr>
												<th>Status:</th>
												<td nowrap="nowrap"><html:text property="status"
														styleClass="input" value="${machineType.status}" /></td>
											</tr>
											<tr>
												<td nowrap="nowrap"><span class="button-blue">
														<html:submit property="action" value="Update" /> <html:cancel
