				...
				<div id="ibm-leadspace-head" class="ibm-alternate">
					<div id="ibm-leadspace-body">
						<p id="breadcrumbs">
							...
							&gt;
							<html:link
								page="/lpar/view.do?accountId=${account.customer.accountNumber}&lparName=${lpar.name}">
								...
								<html:form action="/software/applyCopy">
									...
									<display:table name="list" requestURI=""
										...
										<display:column property="name" title="Name" sortable="true"
											...
											href="/BRAVO/lpar/view.do?accountId=${account.customer.accountNumber}"
											paramId="lparName" paramProperty="name" />
