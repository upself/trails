				...
				<div id="ibm-leadspace-head" class="ibm-alternate">
					<div id="ibm-leadspace-body">
						...
						<c:choose>
							...
							&gt;
							<html:link
								page="/software/selectInit.do?accountId=${account.customer.accountNumber}&lparName=${lparName}&lparId=${lparId}">
								Select		
							</html:link>
						</p>
							...
							<div class="ibm-col-1-1">
								...
								<html:form action="/software/select">
									...
									<table border="0" width="98%" cellspacing="10" cellpadding="0">
										<thead>
											<tr>
												<th>Software Name/Mfg Search:</th>
											</tr>
										</thead>
										<tbody>
											<tr>
								...
								<display:table name="list" requestURI=""
									...
									<display:setProperty name="basic.msg.empty_list_row"
										value='<tr class="empty" align="center"><td colspan="{0}">No Software</td></tr>' />

									<display:column property="statusImage" title=""
										headerClass="blue-med" />

									<display:column property="softwareItem.name" title="Name"
										sortable="true" headerClass="blue-med"
										href="/BRAVO/software/create.do?accountId=${accountId}&lparName=${lparName}&lparId=${lparId}"
										paramId="softwareId" paramProperty="id" />
									<display:column property="manufacturer.manufacturerName"
										title="Manufacturer" sortable="true" headerClass="blue-med" />
									<display:column property="level" title="License Level"
										sortable="true" headerClass="blue-med" />
									<display:column property="softwareType" title="Type"
										sortable="true" headerClass="blue-med" />
