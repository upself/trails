...
<body id="ibm-com">
 ...
 %>
								...
								<display:table name="scriptSignaturesList" requestURI=""
									class="ibm-data-table ibm-sortable-table ibm-alternate-two"
									id="small">
									<display:setProperty name="basic.empty.showtable" value="true" />

									<display:column property="installedScript.softwareScript.softwareName"
										title="Name" headerClass="blue-med" />
									<display:column property="installedScript.softwareScript.softwareVersion"
										title="Version" headerClass="blue-med" />
