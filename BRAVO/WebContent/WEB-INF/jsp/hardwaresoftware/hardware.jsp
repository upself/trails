			...
			<c:choose>
				...
				<c:otherwise>
					...
					<td><font class="orange-dark"><c:out
								value="${lpar.hardwareLpar.hardware.machineType.name}" />
					</font>
					</td>
					<td><font class="orange-dark"><c:out
								value="${lpar.hardwareLpar.hardware.machineType.type}" />
					</font>
					</td>
					<td><font class="orange-dark"><c:out
								value="${lpar.hardwareLpar.hardware.serial}" />
					</font>
					</td>
					<td><font class="orange-dark"><c:out
								value="${lpar.hardwareLpar.hardware.country}" />
					</font>
					</td>
					<td><font class="orange-dark"><c:out
								value="${lpar.hardwareLpar.hardware.processorCount}" />
					</font>
					</td>
					<td><font class="orange-dark"><c:out
								value="${lpar.hardwareLpar.extId}" />
					</font>
					</td>
					<td><font class="orange-dark"><c:out
								value="${lpar.hardwareLpar.techImageId}" />
					</font>
					</td>
					<td><font class="orange-dark"><c:out
								value="${lpar.hardwareLpar.hardware.chips}" />
					</font>
					</td>
					<td><font class="orange-dark"><c:out
								value="${lpar.hardwareLpar.hardware.serverType}" />
					</font>
					</td>
					<td><font class="orange-dark"><c:out
								value="${lpar.hardwareLpar.hardware.hardwareStatus}" />
					</font>
					</td>
					<td><font class="orange-dark"><c:out
								value="${lpar.hardwareLpar.lparStatus}" />
					</font>
					</td>
					<c:if
						test="${lpar.hardwareLpar.hardware.machineType.type == 'MAINFRAME'}">
						<td><font class="orange-dark"><c:out
									value="${lpar.hardwareLpar.hardware.cpuMIPS}" />
						</font>
						</td>
						<td><font class="orange-dark"><c:out
									value="${lpar.hardwareLpar.hardware.cpuMSU}" />
						</font>
						</td>
						<td><font class="orange-dark"><c:out
									value="${lpar.hardwareLpar.partMIPS}" />
						</font>
						</td>
						<td><font class="orange-dark"><c:out
									value="${lpar.hardwareLpar.partMSU}" />
						</font>
						</td>
					</c:if>
				</c:otherwise>
