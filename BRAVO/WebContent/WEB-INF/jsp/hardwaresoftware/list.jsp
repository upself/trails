...
<%@page
	import="java.util.Properties,java.io.FileInputStream,java.lang.String,com.ibm.tap.misld.framework.Constants"%>
<html lang="en">
<head>
...
<p><!-- Create Hardware Discrepancy --> <img
	src="//w3.ibm.com/ui/v8/images/icon-link-add-dark.gif" width="13"
	height="13" /> <html:link
	page="/hardware/lpar/create.do?accountId=${account.customer.accountNumber}">Create HW LPAR Discrepancy</html:link><br />
...
<c:if
	test="${account.customer.customerType.customerTypeName == 'STRATEGIC OUTSOURCING MAINFRAME'}">
	<!-- Upload SCRT Report -->
...
<table class="tableHeader" id="small">
	<tr>
		...
		<td width="1%" nowrap="nowrap"><html:link
			page="/lpar/search.do?context=lpar&accountId=${account.customer.accountNumber}&search=${compositeSearch.search}&type=Search&status=all">
					Show All
				</html:link></td>
	</tr>
</table>
