							...
							<div class="ibm-container-body">
								<ul class="ibm-link-list">
									...
									<li><a class="ibm-add1-link"
										href="/BRAVO/admin/machinetype/home.do">Manage Machine Types</a></li>
								</ul>
								...
								<div class="callout" id="reports">
									...
									<h2 class="ibm-rule">Reports</h2>
									<ul class="ibm-link-list">
										<li><a class="ibm-download-link"
										href="/BRAVO/download/globalDiscrepancies.tsv?name=globalDiscrepancies">Global Discrepancies</a></li>
									</ul>
								</div>
							</div>
						</div>
