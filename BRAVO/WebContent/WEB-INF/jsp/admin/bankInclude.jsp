			...
			<div id="ibm-content">
				<div id="ibm-leadspace-head" class="ibm-alternate">
					<div id="ibm-leadspace-body">
						...
						<h1>
							Bank Account Maintenance for Account Number:
						...
						<div class="ibm-columns">
							<div class="ibm-col-1-1">
								...
								<html:form
									...
									<display:table name="bankInclude" requestURI=""
										class="ibm-data-table ibm-sortable-table ibm-alternate-two"
										id="includes">
										<display:setProperty name="basic.empty.showtable" value="true" />
										<display:column title="Remove Inclusion"
											headerClass="blue-med">
											<html:multibox property="selectedIncludes"
									...
									<display:table name="customerBank" requestURI=""
										class="ibm-data-table ibm-sortable-table ibm-alternate-two"
										id="bank">
										<display:setProperty name="basic.empty.showtable" value="true" />
					value='<tr class="empty" align="center">
											<td colspan="{0}">No bank accounts</td>
										</tr>' />
						...
						<display:column title="Create Inclusion" headerClass="blue-med">
									...
									<span class="button-blue"> <html:submit
											property="action" value="Submit Changes" />
									</span>
								</html:form>
