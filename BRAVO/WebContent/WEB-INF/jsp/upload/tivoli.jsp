...
<title>Bravo Upload TCM Script TAR File: <c:out
				...
				<div id="ibm-leadspace-head" class="ibm-alternate">
					<div id="ibm-leadspace-body">
						<p id="breadcrumbs">
							...
							&gt;
							<html:link
								page="/upload/tivoli.do?id=${account.customer.accountNumber}">
                                Upload TCM Script TAR File
                        </html:link>
						</p>
						<h1>
							Upload TCM Script TAR File: <font class="green-dark">
					...
					<div id="ibm-content-main">
						<div class="ibm-columns">
							<div class="ibm-col-1-1">
								...
								<p>
									<font color="red">The legacy standalone scan solution,
									often referred to as the TCM or TLCM Script, has been
									discontinued. BRAVO no longer accepts scan output files from
									the legacy solution. All copies of the legacy scripts should be
									removed from IBM managed systems. A replacement solution based
									on TAD4D technology has been deployed. Please follow this link
									to the replacement solution: <a
										href="http://tap.raleigh.ibm.com/EMEA/StandaloneScanScripts/">TAD4D
										Standalone solution</a></font>
								</p>
