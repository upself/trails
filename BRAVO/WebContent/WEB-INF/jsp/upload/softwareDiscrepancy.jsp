...
<html lang="en">
<head>
	<title>Bravo Upload Software Discrepancy: <c:out value="${account.customer.customerName}"/></title>
...
<!-- START CONTENT HERE -->
	...
	<div id="content-head">
		...
		<p id="breadcrumbs">
			...
			&gt;
			<html:link page="/upload/softwareDiscrepancy.do?id=${account.customer.accountNumber}">
				Upload Software Discrepancy
			</html:link>
		</p>
	</div>
	...
	<div id="partial-sidebar">
		...
		<div class="action">
			...
			<p>
				...
				<a href="/BRAVO/download/BRAVO Mass Missing SW Discrepancy Template.xls?name=softwareDiscrepancyBlank&accountId=${account.customer.accountNumber}">SW Discrepancy Upload Template</a>
	...
	<h1>Upload Software Discrepancy: <font class="green-dark"><c:out value="${account.customer.customerName}"/></font></h1>
	<p class="confidential">IBM Confidential</p>
	<br/><br/>
	
	<html:form action="/upload/upload" enctype="multipart/form-data">
	<html:hidden property="uploadType" value="softwareDiscrepancy"/>
