...
<title>Bravo Upload Software Discrepancy: <c:out
				...
				<div id="ibm-leadspace-head" class="ibm-alternate">
					<div id="ibm-leadspace-body">
						<p id="breadcrumbs">
							...
							&gt;
							<html:link
								page="/upload/softwareDiscrepancy.do?id=${account.customer.accountNumber}">
								Upload Software Discrepancy
							</html:link>
						</p>
						<h1>
							Upload Software Discrepancy: <font class="green-dark"> <c:out
						...
						<div class="ibm-columns">
							<div class="ibm-col-1-1">
								...
								<html:form action="/upload/upload" enctype="multipart/form-data">
									...
									<html:hidden property="hardwareSoftwareId"
										value="${account.customer.accountNumber}" />
