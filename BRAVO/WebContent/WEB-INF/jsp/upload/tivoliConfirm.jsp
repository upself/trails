...
<!-- START CONTENT HERE -->
	...
	<html:hidden property="uploadType" value="tivoli"/>
	...
	<p>
		Important Note: Please ensure to load only FILENAME.TAR files which should contain individual .tar.z files. Do not submit the tar.z files without first wrapping them into a TAR file.
	</p><br/>
	
	<p>
		Your TCM script has been submitted successfully and will be processed in tonight's batch load.<br/>
		<br/>
		Click <html:link page="/account/view.do?accountId=${account.customer.accountNumber}">here</html:link> to return to <c:out value="${account.customer.customerName}"/>
