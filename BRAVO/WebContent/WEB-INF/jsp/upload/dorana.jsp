...
<html lang="en">
<head>
	<title>Bravo Upload Dorana: <c:out value="${hardware.name}"/></title>
...
<!-- START CONTENT HERE -->
	...
	<div id="content-head">
		<p id="date-stamp">New as of 7 September 2006</p>
	...
	<h1>Upload Dorana File: <font class="green-dark"><c:out value="${hardware.name}"/></font></h1>
	<p class="confidential">IBM Confidential</p>
	<br/><br/>

	<html:form action="/upload/loadScanLoad" method="post" enctype="multipart/form-data">
	<html:hidden property="scanType" value="dorana"/>
