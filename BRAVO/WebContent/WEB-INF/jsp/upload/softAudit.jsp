...
<html lang="en">
<head>
	<title>Bravo upload TLCMz account: <c:out value="${account.customer.accountNumber}"/></title>
...
<!-- START CONTENT HERE -->
	...
	<h1>Upload TLCMz file account: <c:out value="${account.customer.customerName}"/> <font class="green-dark"><c:out value="${account.customer.accountNumber}"/></font></h1>
