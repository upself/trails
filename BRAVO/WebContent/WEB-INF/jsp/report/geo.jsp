			...
			<div id="ibm-content">
				...
				<div id="ibm-content-body">
					<div id="ibm-content-main">
						...
						<h1>GEO Scan Report</h1>
						<p class="confidential">IBM Confidential</p>
						<br />
						<display:table name="report" requestURI=""
							class="ibm-data-table ibm-sortable-table ibm-alternate-two">
							<display:setProperty name="basic.empty.showtable" value="true" />

							<display:column property="customerName" title="GEO"
								headerClass="blue-med" sortable="true" href="deptrollup.do"
								paramId="geo" paramProperty="geographyId" />
							<display:column property="customerType" title="Region"
								headerClass="blue-med" sortable="true" href="deptrollup.do"
								paramId="region" paramProperty="regionId" />
							<display:column property="swAnalyst" title="Country"
								headerClass="blue-med" sortable="true" href="deptrollup.do"
								paramId="country" paramProperty="countryCodeId" />
							...
							<display:column property="hwLpars" title="Tot. HW"
								headerClass="blue-med" sortable="true" />
							<display:column property="hwSwComposites"
								title="Tot. HW/SW Composite" headerClass="blue-med"
								sortable="true" />
