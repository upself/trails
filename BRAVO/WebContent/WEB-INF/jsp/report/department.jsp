			...
			<div id="ibm-content">
				...
				<div id="ibm-content-body">
					<div id="ibm-content-main">
						...
						<br />
						<html:form action="/report/department.do">
							<label for="id_podId">Department</label>: <html:select
								property="id">
						...
						<display:table name="report" requestURI=""
							...
							<display:column property="accountNumber" title="Account"
								...
								href="/BRAVO/account/view.do" paramId="accountId"
								paramProperty="accountNumber" />
