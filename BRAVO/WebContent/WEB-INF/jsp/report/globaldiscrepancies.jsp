							...
							<div class="ibm-col-1-1">
								...
								<display:table name="report" requestURI=""
									...
									<display:column property="customerName" title="Account Name"
										headerClass="blue-med" sortable="true" />
									<display:column property="customerTypeName"
										title="Account Type" headerClass="blue-med" sortable="true" />
									...
									<display:column property="softwareName" title="Software Name"
										headerClass="blue-med" sortable="true" />
									<display:column property="discrepancyTypeName"
										title="Discrepancy Type" headerClass="blue-med" />
									<display:column property="invalidCategory"
										title="Invalid Category" headerClass="blue-med" />
