		...
		<div id="content-main">
			...
			<div id="partial-sidebar">
				...
				<div class="callout" id="contacts">
					<!--<div class="action"> removed by donnie 7/23 -->
					...
					<!-- Exclude Account -->
					<img src="//w3.ibm.com/ui/v8/images/icon-link-add-dark.gif"
						width="13" height="12" />
					<html:link
						page="/admin/bank.do?accountId=${account.customer.accountNumber}">Bank Account Inclusion List</html:link>
					<br />
					<!-- Create Contact -->
					<img src="//w3.ibm.com/ui/v8/images/icon-link-add-dark.gif"
						width="13" height="13" />
					<html:link
						page="/contact/create.do?context=ACCOUNT&accountId=${account.customer.accountNumber}&id=&lparId=&customerid=${account.customer.customerId}">Create Account Contacts</html:link>
					<br />

					<!-- Refresh/Update Existing Account Contacts -->
					<img src="//w3.ibm.com/ui/v8/images/icon-link-action.gif"
						width="13" height="13" />
					<html:link
						page="/contact/update.do?accountId=${account.customer.accountNumber}&context=ACCOUNT&id=&lparId=&customerid=${account.customer.customerId}">Update Account Contacts</html:link>
					<br />

					<!-- Upload Tar Files -->
					<img src="//w3.ibm.com/ui/v8/images/icon-link-upload.gif"
						width="14" height="13" />
					<html:link
						page="/upload/tivoli.do?id=${account.customer.accountNumber}">Upload TCM Script TAR File</html:link>
					<br />
					...
					<img src="//w3.ibm.com/ui/v8/images/icon-link-upload.gif"
						width="14" height="13" />
					<html:link
						page="/upload/softwareDiscrepancy.do?id=${account.customer.accountNumber}">Upload SW Discrepancy</html:link>
					<br />
					...
					<br />
					<!-- Delete SWASSET data -->
					<img src="//w3.ibm.com/ui/v8/images/icon-link-delete-dark.gif"
						width="13" height="13" />
					<html:link
				...
				<br />
				<c:set var="scanValidity" value="${account.customer.scanValidity}" />
				...
				<div class="callout" id="reports">
					<h2 class="bar-gray-med-dark">
						Reports
						<html:link page="/help/help.do#10">
							<img alt="Help"
								src="//w3.ibm.com/ui/v8/images/icon-help-contextual-light.gif"
								width="14" height="14" alt="contextual field help icon" />
						</html:link>
					...
					<p>
						...
						<img src="//w3.ibm.com/ui/v8/images/icon-link-download.gif"
							width="14" height="12" /> <a
							...
							SW Component Discrepancies</a><br />
...
Expired Scan Report</a> -->
						Only scans within the last ${account.customer.scanValidity} days
						are valid. <br />
						<!-- Trails reports -->
						<img src="//w3.ibm.com/ui/v8/images/icon-link-download.gif"
							width="14" height="12" /> <a
			...
			<html:form action="/authorizedAsset/searchLpars">
				...
				<table border="0" width="65%" cellspacing="10" cellpadding="0">
					<thead>
						<tr>
							<th>LPAR Name/Serial Search: <html:link
					...
					<tbody>
						<tr>
							<td><html:text property="search" styleClass="inputlong" />
								<span class="button-blue"><html:submit property="type"
		...
		<display:table name="hardwareLpars" requestURI=""
			class="ibm-data-table ibm-sortable-table ibm-alternate-two" id="tall"
