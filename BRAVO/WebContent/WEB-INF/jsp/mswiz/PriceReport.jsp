...
<dl>
	...
	<dt><logic:equal name="priceReport" property="overallNodeOwnerFlag"
		value="true">
		<bean:write name="priceReport" property="nodeOwnerAssumption" />
	</logic:equal></dt>
...
<table class="basic-table" border="0" cellspacing="1" cellpadding="0"
	width="100%" style="margin-top:2em;">
	<tr class="tablefont">
		<th colspan="17" style="white-space:nowrap; background-color:#bd6;">Details</th>
	</tr>
	<tr style="background-color:#dfb;" class="tablefont">
	...
	<%alternate = true;
		%>
	<logic:iterate id="detail" name="priceReport" property="details">
		<%alternate = alternate ? false : true;
		if (alternate) {
			out.println("<tr class=\"gray\" style=\"font-size:8pt\">");
		} else {
	...
	%>
		...
		<td><bean:write name="detail" property="country" /></td>
		<td><bean:write name="detail" property="nodeName" /></td>
		<td><bean:write name="detail" property="serialNumber" /></td>
		<td><bean:write name="detail" property="machineType" /></td>
		<td><bean:write name="detail" property="machineModel" /></td>
		<td><bean:write name="detail" property="scanDate" /></td>
		<td><bean:write name="detail" property="nodeOwnerFlag" /><bean:write
			name="detail" property="nodeOwner" /></td>
		<td><bean:write name="detail" property="softwareOwnerFlag" /><bean:write
			name="detail" property="softwareOwner" /></td>
		<td><bean:write name="detail" property="processorFlag" /><bean:write
			name="detail" property="processorCount" /></td>
		<td><bean:write name="detail" property="userFlag" /><bean:write
			name="detail" property="userCount" /></td>
		<td><bean:write name="detail" property="authenticatedFlag" /><bean:write
			name="detail" property="authenticated" /></td>
		<td><bean:write name="detail" property="sku" /></td>
		<td><bean:write name="detail" property="licenseType" /></td>
		<td><bean:write name="detail" property="noOsFlag" /><bean:write
			name="detail" property="productDescription" /></td>
		<td><bean:write name="detail" property="licenseAgreementTypeFlag" /><bean:write
			name="detail" property="licenseAgreementType" /></td>
		<td><bean:write name="detail" property="splaQuarterlyPrice" /></td>
		<td><bean:write name="detail" property="esplaYearlyPrice" /></td>
