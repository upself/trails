...
<br>
<p>Use this form to add a new object to the price list.
When you are finished, click the submit button. Press the Cancel button
...
<html:form action="/SaveNewMicrosoftPriceList">
	...
	<table cellspacing="0" cellpadding="0" class="sign-in-table">
		...
		<tr>
			<td class="t1"><label for="select_microsoftProduct">*Microsoft Product: </label></td>
			<td class="t1">
			<html:select property="microsoftProductId" styleId="select_microsoftProduct">
				<html:options collection="product.list"
					labelProperty="productDescription" property="microsoftProductId" />
			</html:select>
		</tr>
		<tr>
			<td class="t1"><label for="select_licenseAgreementType">*License Agreement
			Type: </label></td>
			<td class="t1">
			<html:select property="licenseAgreementTypeId" styleId="select_licenseAgreementType">
		...
		<tr>
			<td class="t1"><label for="select_licenseType">*License Type: </label></td>
			<td class="t1">
		...
		<tr>
			<td class="t1"><label for="select_priceLevel">Price Level: </label></td>
			<td class="t1">
		...
		<tr>
			<td class="t1"><label for="select_qualifiedDiscount">Qualified Discount: </label></td>
			<td class="t1">
			<html:select property="qualifiedDiscountId" styleId="select_qualifiedDiscount">
				<html:options collection="qualifiedDiscount.list"
					labelProperty="qualifiedDiscount" property="qualifiedDiscountId" />
			</html:select>
		</tr>
		<tr>
			<td class="t1"><label for="select_authenticated">Authenticated: </label></td>
			<td>
