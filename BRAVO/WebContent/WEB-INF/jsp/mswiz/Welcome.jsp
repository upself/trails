			...
			<div id="ibm-content">
				<div id="ibm-leadspace-head" class="ibm-alternate">
					<div id="ibm-leadspace-body">
						<h1>Microsoft License Wizard Home</h1>
						<br> <html:img page="/images/p1_w3v8_19.jpg"
								alt="MS Wizard logo" align="left" hspace="10" vspace="10" />

							<p style="color: #c60" class="caption">Microsoft License Wizard</p>
							<br> The Microsoft License Wizard is an asset
								management tool used to assist in the licensing and purchasing
								of Microsoft software. Please see the help documentation by
								clicking on the link below or contact an asset management
								representative for assistance. 
							<br> 
							<html:errors property="access" /> 
							<br clear="all"> 
							<br> 
							<br clear="all">
					</div>
	...
	<div id="ibm-navigation">
		...
		<ul id="ibm-primary-links">
			...
			<li id="ibm-overview"><a href="/BRAVO/bankAccount/home.do">Bank
					...
					<ul>
						<li><a href="/BRAVO/bankAccount/connected.do">Connected</a> <logic:equal
								scope="request" name="bankAccountSection" value="CONNECTED">
								<%
									if (lbAdminRole) {
								%>
								<ul>
