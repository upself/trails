...
<logic:notEmpty name="customer.list">
	...
	<table class="basic-table" border="0" cellspacing="1" cellpadding="0"
		...
		<tr class="tablefont">
			<th colspan="10" style="white-space: nowrap; background-color: #bd6;"><html:form
				action="/Pod">
		...
		<logic:iterate id="customer" name="customer.list">
			...
			<td><logic:notEmpty name="customer" property="misldRegistration">
				...
				<logic:notEqual name="customer" property="misldRegistration.status"
					...
					<logic:equal name="customer" property="misldRegistration.inScope"
						value="false">
						<img
							alt="Out-Of-Scope" src="https://w3.ibm.com/ui/v8/images/icon-system-status-na.gif"
							width="12" height="10">
					</logic:equal>
					<logic:equal name="customer" property="misldRegistration.inScope"
						value="true">
			...
			<td><html:link action="/Customer.do" paramId="customer"
