...
<ul class="text-tabs">
	<li><html:link page="/AdminPod.do">Unlock customers</html:link> |</li>
	<li><html:link page="/ScanNotification.do" styleClass="active">DPE scan notification</html:link>
	|</li>
...
<html:form action="/ScanNotify">
	...
	%>
			...
			<td><html:checkbox name="customer"
				property="misldAccountSettings.status" value="send" indexed="true" /><logic:notEmpty
				name="customer" property="scanNotification">
				<bean:write name="customer" property="scanNotification.remoteUser" />
				<br>
				<bean:write name="customer" property="scanNotification.recordTime" />
			</logic:notEmpty></td>
			</tr>
		</logic:iterate>
	</table>
