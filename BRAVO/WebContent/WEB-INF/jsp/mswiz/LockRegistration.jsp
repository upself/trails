...
<ul class="text-tabs">
	...
	|</li>
	<li><html:link page="/LockRegistration.do" styleClass="active">Lock/Unlock agreements</html:link>
	|</li>
</ul>
</div>
<br>
...
<html:form action="/LockAccountRegistration">
	<table class="basic-table" border="0" cellspacing="1" cellpadding="0"
		...
		<tr style="background-color:#dfb;" class="tablefont">
			...
			<th nowrap="nowrap">Locked</th>
			<th nowrap="nowrap">Unlocked</th>
		</tr>
	...
	%>
			...
			<td><html:radio name="customer" property="misldRegistration.status"
				indexed="true" value="COMPLETE" /></td>
			</tr>
		</logic:iterate>
	</table>
	<div class="clear"></div>
