 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class DuplicatePrefixReportBatch extends BatchBase implements IBatch,
		Serializable {
	...
	public DuplicatePrefixReportBatch(String remoteUser) 
	...
	public void sendNotify() {
		...
		try {
			setFrom("DUPLICATE-PREFIX-REPORT");
			setSubject("Duplicate prefix report");
			setTo(remoteUser);
		} catch (Exception e) {
			logMsg(e);
		}
		try {
			...
			xlsReport.setXlsReport(MsHardwareBaselineReadDelegate
					.getDuplicatePrefixReport(remoteUser));
			...
			if (wb != null) {
				...
				String fileOutName = "duplicate_prefix_report_" + ".xls";
				...
				addBody("The Duplicate Prefix report is attached below.");
	...
	public String getName() {
		return "Duplicate Prefix Report";
	}
