 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class MappingLoaderBatch
    ...
    public MappingLoaderBatch(String remoteUser, String dir, FormFile file)
            throws Exception {
    ...
    public void execute() throws Exception {
        ...
        for (int i = 0; i < endi; i++) {
            ...
            try {
                int size = 3;
                MicrosoftProductMapWriteDelegate.loadMapping(getStringFields(
    ...
    public void sendNotify() {
        try {
            addBody("The mapping has been uploaded.");
            sendMsg(remoteUser);
        }
