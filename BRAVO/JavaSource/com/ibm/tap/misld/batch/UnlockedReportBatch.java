 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class UnlockedReportBatch extends BatchBase implements IBatch,
		Serializable {
	...
	public UnlockedReportBatch(String remoteUser) 
	...
	public void sendNotify() {
		...
		try {
			setFrom("UNLOCKED-ACCOUNTS-REPORT");
			setSubject("Unlocked Accounts report");
			setTo(remoteUser);
		} catch (Exception e) {
			logMsg(e);
		}
		try {
			...
			xlsReport.setXlsReport(MisldRegistrationReadDelegate
					.getUnlockedAccountReport());
			...
			if (wb != null) {
				...
				String fileOutName = "unlocked_accounts_report_" + ".xls";
				...
				addBody("The Unlocked account report is attached below.");
	...
	public String getName() {
		return "Unlocked Accounts Report";
	}
