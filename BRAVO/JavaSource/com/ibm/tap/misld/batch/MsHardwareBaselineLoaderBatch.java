 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class MsHardwareBaselineLoaderBatch
    ...
    public MsHardwareBaselineLoaderBatch(String remoteUser, String dir,
            FormFile file, Customer customer) throws Exception {
    ...
    public void execute() throws Exception {
        ...
        try {
            setFrom("HARDWARE-BASELINE-LOADER");
        ...
        for (int i = 0; i < endi; i++) {
            ...
            try {
                ...
                MsHardwareBaselineWriteDelegate.loadHardware(getStringFields(
                        row, sheet, size), remoteUser, customer);
            }
    ...
    public void sendNotify() {
        try {
            addBody("The hardware baseline has been uploaded.");
            sendMsg(remoteUser);
        }
    ...
    public String getName() {
        return "Hardware baseline loader";
    }
