 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class MsInstalledSoftwareBaselineLoaderBatch
    ...
    public MsInstalledSoftwareBaselineLoaderBatch(String remoteUser,
            String dir, FormFile file, Customer customer) throws Exception {
    ...
    public void execute() throws Exception {
        ...
        try {
            setFrom("SOFTWARE-BASELINE-LOADER");
        ...
        for (int i = 1; i < endi; i++) {
            ...
            try {
                ...
                MsInstalledSoftwareBaselineWriteDelegate
                        .loadSoftware(getStringFields(row, sheet, size),
                                remoteUser, customer);
            }
    ...
    public void sendNotify() {
        try {
            addBody("The software baseline has been uploaded.");
            sendMsg(remoteUser);
        }
    ...
    public String getName() {
        return "Software baseline loader";
    }
