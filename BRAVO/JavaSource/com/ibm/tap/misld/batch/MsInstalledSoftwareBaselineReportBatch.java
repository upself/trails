 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class MsInstalledSoftwareBaselineReportBatch
    ...
    public MsInstalledSoftwareBaselineReportBatch(Customer customer,
            String remoteUser) 
    ...
    public void sendNotify() {
        ...
        reportTemplateFilename = "MS_Software_Loader_Template.xls";

        try {
            setFrom("SOFTWARE-BASELINE-REPORT");
            setSubject("Software Baseline Report for: "
        ...
        try {
            ...
            if (wb != null) {
                ...
                String fileOutName = "software_baseline_report_"
                ...
                addBody("The Software Baseline report for "
