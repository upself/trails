 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class SplaPoReportBatch
    ...
    public SplaPoReportBatch(String remoteUser) 
    ...
    public void sendNotify() {
        ...
        try {
            setFrom("SPLA-PO-REPORT");
            setSubject("Spla PO Report");
            setTo(remoteUser);
        }
        catch (Exception e) {
            logMsg(e);
        ...
        try {
            ...
            if (wb != null) {
                ...
                String fileOutName = "spla_po_report.xls";
                ...
                addBody("Spla PO report is attached below.");
