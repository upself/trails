 ...
 */
public class SoftwareDiscrepancyLoaderTemplate extends DownloadReport implements
		IReport {
	private static final Logger logger = Logger
			.getLogger(SoftwareDiscrepancyLoaderTemplate.class);

	public SoftwareDiscrepancyLoaderTemplate() {
	}

	public SoftwareDiscrepancyLoaderTemplate(OutputStream outputStream) {
	...
	public void execute(String[] args, HttpServletRequest request)
		...
		try {
			workbook = Workbook.getWorkbook(new File(
					Constants.SOFTWARE_DISCREPANCY_BLANK_FILE));
