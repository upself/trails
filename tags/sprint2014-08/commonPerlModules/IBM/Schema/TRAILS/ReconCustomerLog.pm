package IBM::Schema::TRAILS::ReconCustomerLog;
...
__PACKAGE__->add_unique_constraint("IF1RECONCUSTLOG", ["id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:0/UxKXPKJVsMTr3h7cvPOw
