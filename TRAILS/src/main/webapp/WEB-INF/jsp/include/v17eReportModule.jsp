...
<s:form action="reportList" method="get" namespace="/report/download" theme="simple">
	...
	<table class="basic-table" cellspacing="0" cellpadding="0">
		...
		<table id="checkboxlist" class="basic-table" cellspacing="0" cellpadding="0">
			<tr>
				<td><s:checkbox label="Customer owned/customer managed titles/vendors"
						name="customerOwnedCustomerManagedSearch" id="customerOwnedCustomerManagedSearch" /><label
					for="customerOwnedCustomerManagedSearch">Customer owned/customer managed titles/vendors</label></td>
			</tr>
			<tr>
				<td><s:checkbox label="Customer owned/IBM managed titles/vendors" name="customerOwnedIBMManagedSearch"
						id="customerOwnedIBMManagedSearch" /><label for="customerOwnedIBMManagedSearch">Customer owned/IBM
						managed titles/vendors</label></td>
			</tr>
			<tr>
				<td><s:checkbox label="IBM owned/IBM managed titles/vendors" name="ibmOwnedIBMManagedSearch"
						id="ibmOwnedIBMManagedSearch" /><label for="ibmOwnedIBMManagedSearch">IBM owned/IBM managed
						titles/vendors</label></td>
			</tr>
			<tr>
				<td><s:checkbox label="IBM owned/ managed by 3rd party
					titles/vendors" name="ibmO3rdMSearch"
						id="ibmO3rdMSearch" /><label for="ibmO3rdMSearch">IBM owned/ managed by 3rd party titles/vendors</label></td>
			</tr>
			<tr>
				<td><s:checkbox label="Customer owned/ managed by 3rd party 
					titles/vendors" name="custO3rdMSearch"
						id="custO3rdMSearch" /><label for="custO3rdMSearch">Customer owned/ managed by 3rd party titles/vendors</label></td>
			</tr>
			<tr>
				<td><s:checkbox label="IBM owned/IBM managed SW consumption based 
					titles/vendors"
						name="ibmOibmMSWCOSearch" id="ibmOibmMSWCOSearch" /><label for="ibmOibmMSWCOSearch">IBM owned/IBM managed
						SW consumption based titles/vendors</label></td>
			</tr>
			<tr>
				<td><s:checkbox label="Customer owned/IBM managed SW consumption based 
					titles/vendors"
						name="custOibmMSWCOSearch" id="custOibmMSWCOSearch" /><label for="custOibmMSWCOSearch">Customer owned/IBM
						managed SW consumption based titles/vendors</label></td>
			</tr>
			<tr>
				<td><s:checkbox label="Titles not specified in contract scope" name="titlesNotSpecifiedInContractScopeSearch"
						id="titlesNotSpecifiedInContractScopeSearch" /><label for="titlesNotSpecifiedInContractScopeSearch">Titles
						not specified in contract scope</label></td>
			</tr>
			<tr>
				<td><s:checkbox label="selectAll" name="selectAll" id="selectAll" /><label for="selectAll">SelectALL</label></td>
			</tr>
		</table>
