...
<h1>SOM1b: HW BOX CRITICAL CONFIGURATION DATA POPULATED: <s:property value="account.name" />(<s:property
...
<div class="download-link" style="float:right">
	...
	<s:a href="%{reportUrl}">Download SOM1b: HW BOX CRITICAL CONFIGURATION DATA POPULATED alert report</s:a>
</div>
<br />
<br />
