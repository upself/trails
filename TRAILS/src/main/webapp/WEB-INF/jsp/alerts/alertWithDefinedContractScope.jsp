...
<h1>SOM 3: SW Instances with Defined Contract Scope: <s:property value="account.name" />(<s:property
...
<div class="download-link" style="float:right">
	...
	<s:a href="%{reportUrl}">Download SOM 3: SW Instances with Defined Contract Scope</s:a>
</div>
<br />
<br />
