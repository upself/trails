...
<div class="ibm-columns">
	<div class="ibm-col-1-1">
		...
		<div style="text-align:right">
			<a href="${pageContext.request.contextPath}/ws/alertIsvSwInstancesReviewed/download/${accountId}">Download SOM4c: ISV SW INSTANCES REVIEWED alert report</a>
		</div>
		<br />
	</div>
...
function searchData(){
	...
	$("#pagebar").v17ePagination({
		...
		showPageSizes: true,
		remote: {
			url: "${pageContext.request.contextPath}/ws/alertIsvSwInstancesReviewed/search",
			type: "POST",
			params: params,
