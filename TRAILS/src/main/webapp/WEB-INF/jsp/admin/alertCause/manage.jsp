	...
	$
			.ajax({
				...
				success : function(result) {
					...
					$("#responsibilityId").val(result.data.pk.alertCause.alertCauseResponsibility.id);
					$("#responsibility").val(result.data.pk.alertCause.alertCauseResponsibility.name);
...
function callRestApi() {
	...
	var obj = "{\"pk\":{\"alertType\":{\"id\":"+ $("#alertTypeId").val() +",\"name\":\" "+ $("#alertTypename").text() +"\",\"code\":\"\"},\"alertCause\":{\"id\":"+ $("#causeTypeId").val() +",\"name\":\" "+ $("#causeType").val() +"\",\"showInGui\":true,\"alertCauseResponsibility\":{\"id\":"+ $("#responsibilityId").val() +" ,\"name\":\" "+ $("#responsibility").val() +"\"}}},\"status\":\""+ $("#status").val() +"\"}";
...
function validateEmpty() {
	...
	if ($("#causeType").val() == null
			|| $("#causeType").val() == '') {
		$("#causeTypeError").text(
				"Please enter Alert Cause Name.");
...
<br />
<p>Edit the cause code's name. Press the Save button to save your changes. Fields marked with an asterisk (*) are required.</p>
<br />
		...
		<span class="ibm-spinner-large" id="loading" style="display:none"></span>
			...
			<p>
				<label for="alertTypename">Alert:<span class="ibm-required">*</span>
						...
						<label id="alertTypename" name="alertTypename"></label>
					</span>
					<input type="hidden" id="alertTypeId" />
			</p>
			...
			<p>
				...
				<select name="responsibility" id="responsibility" style="max-width:270px;">
					</select> 				
				</span>
