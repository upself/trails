			...
			<div style="float: right">
				<div style="width:200px">
					<p class='ibm-button-link'>
						<a class="ibm-btn-small" href="javascript:void(0)" onclick="openLink('${pageContext.request.contextPath}/admin/alertCause/add.htm')" id="addAlerCasue">Add cause code</a>
					</p>
				</div>
			</div>	
		</div>
		...
		<table id="alertcauseTable" cellspacing="0" cellpadding="0" border="0"
			...
			<thead>
				<tr>
					...
					<th scope="col"><span>Cause code name</span><span class="ibm-icon"></span></th>
					<th scope="col"><span>Responsibility</span><span class="ibm-icon"></span></th>
				...
				success : function(data) {
					...
					if (data.status == 400) {
						...
						for (var i = 0; i < list.length; i++) {
							...
							html += "<td>" + list[i].pk.alertCause.alertCauseResponsibility.name
									+ "</td>";
