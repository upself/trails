...
&gt; <s:if
	...
	<s:url id="sectorLink" action="sector" namespace="/reports/dataExceptions"
		includeContext="true" includeParams="none">
		<s:param name="regionId" value="region.id" />
		<s:param name="geographyId" value="geography.id" />
		<s:param name="countryCodeId" value="countryCode.id" />
	...
	<s:url id="geographyLink" action="region" namespace="/reports/dataExceptions"
		includeContext="true" includeParams="none">
	</s:url>
	<s:a href="%{geographyLink}">Geography</s:a> &gt;
...
<div id="fourth-level"><s:if
	...
	<ul class="text-tabs">
		...
		<li><s:a href="%{accountLink}" cssClass="active">Account data exceptions</s:a></li>
	</ul>
