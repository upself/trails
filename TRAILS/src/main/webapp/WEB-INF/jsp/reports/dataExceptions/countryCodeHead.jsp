...
<s:url id="dataExceptions" action="home" namespace="/reports/dataExceptions"
	includeContext="true" includeParams="none">
</s:url>
...
&gt; <s:if test="geography != null && region != null">
	<s:url id="geographyLink" action="geography"
		namespace="/reports/dataExceptions" includeContext="true" includeParams="none">
	</s:url>
	<s:a href="%{geographyLink}">Geography</s:a> &gt;
	
	<s:url id="regionLink" action="region" namespace="/reports/dataExceptions"
		includeContext="true" includeParams="none">
...
<div id="fourth-level"><s:if
	...
	<ul class="text-tabs">
		<li><s:a href="%{countryCodeLink}" cssClass="active">Country code exceptions</s:a>|</li>
		<li><s:a href="%{sectorLink}">Sector exceptions</s:a>|</li>
		<li><s:a href="%{departmentLink}">Department exceptions</s:a></li>
	</ul>
	...
	<ul class="text-tabs">
		<li><s:a href="%{regionLink}">Region exceptions</s:a>|</li>
		<li><s:a href="%{countryCodeLink}" cssClass="active">Country code exceptions</s:a>|</li>
		<li><s:a href="%{sectorLink}">Sector exceptions</s:a>|</li>
		<li><s:a href="%{departmentLink}">Department exceptions</s:a></li>
	</ul>
