...
<div id="fourth-level">
	<s:if test="geography != null && region != null">
		...
		<ul class="ibm-link-list horizontal-list">
			<li><s:a href="%{countryCodeLink}" cssClass="ibm-forward-link"
					cssStyle="font-weight: bold;text-decoration: underline;">Country code exceptions</s:a></li>
			<li><s:a href="%{sectorLink}" cssClass="ibm-forward-link">Sector exceptions</s:a></li>
			<li><s:a href="%{departmentLink}" cssClass="ibm-forward-link">Department exceptions</s:a></li>
		</ul>
	...
	<s:elseif test="geography != null">
		...
		<ul class="ibm-link-list horizontal-list">
			<li><s:a href="%{regionLink}" cssClass="ibm-forward-link">Region exceptions</s:a></li>
			<li><s:a href="%{countryCodeLink}"
					cssStyle="font-weight: bold;text-decoration: underline;">Country code exceptions</s:a></li>
			<li><s:a href="%{sectorLink}" cssClass="ibm-forward-link">Sector exceptions</s:a></li>
			<li><s:a href="%{departmentLink}" cssClass="ibm-forward-link">Department exceptions</s:a></li>
		</ul>
