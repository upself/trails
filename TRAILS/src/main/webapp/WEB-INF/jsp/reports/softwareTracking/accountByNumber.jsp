...
<display:table name="data.list" class="ibm-data-table ibm-sortable-table"
	...
	summary="Software Tracking Only Metrc summary by accountByNumber"
	cellspacing="1" cellpadding="0" defaultsort="1" export="true"
	requestURI="/reports/softwareTracking/accountByNumber.htm">
	<display:setProperty name="export.excel.filename"
		value="alertSwTrackingOnlyByAccountNumber.xls" />
