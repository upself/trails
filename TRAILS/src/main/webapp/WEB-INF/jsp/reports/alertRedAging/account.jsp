...
<display:table name="data.list" class="basic-table"
	...
	summary="AlertRedAging summary by account"
	...
	<display:column property="accountNumber" title="Account #"
		href="/TRAILS/reports/alertRedAging/accountDetail.htm?d-49653-e=2&6578706f7274=1" paramId="accountId" paramProperty="id"
		group="1" media="html" />
