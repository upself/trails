...
<s:if test="geographyId != null">
	<span class="download-link"> <s:url id="accountRegionLink"
			value="accountRegion.htm" includeContext="false" includeParams="none">
