...
<title>IBM v17 POPUP TEMPLATE <tmp:insertAttribute name="contentTitle" /></title>
...
<link href="//1.www.s81c.com/common/v17e/css/social.css" rel="stylesheet" title="www" type="text/css" />
<link href="//1.www.s81c.com/common/v17e/css/module.css" rel="stylesheet" title="www" type="text/css" />
...
ibmweb.config.set({pagetitle: "<tmp:insertAttribute name='contentTitle' />" });
</script>
</head>
	...
	<div id="ibm-top" class="ibm-popup">
		...
		<div id="ibm-masthead">
			...
			<div id="ibm-mast-options">
				<ul>
					<li id="ibm-geo"><a href="http://www.ibm.com/planetwide/select/selector.html"><span class="ibm-access">Select
								a country/region: </span>United States</a></li>
				</ul>
			</div>
			<div id="ibm-universal-nav">
				<ul id="ibm-unav-links">
					<li id="ibm-home"><a href="http://www.ibm.com/us/en/">IBM®</a></li>
					<li id="ibm-title">Text chat</li>
				</ul>
				...
				<div id="ibm-search-module">
					<form method="get" action="http://www.ibm.com/Search/" id="ibm-search-form">
						<p>
