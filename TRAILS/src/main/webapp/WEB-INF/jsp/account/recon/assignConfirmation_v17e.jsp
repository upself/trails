...
initial workspace once the request has completed.</p>
	...
	<div class="ibm-col-1-1">
		<small>
			<display:table name="data.list" class="ibm-data-table ibm-sortable-table ibm-alternating tablesorter tablesorter-default" summary="Assign confirmation" id="row" cellspacing="1" cellpadding="0">
