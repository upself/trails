...
the request has completed.</p>
	...
	<div class="ibm-col-1-1" style="width:99%; overflow-x: auto">
		<small>
			<display:table name="data.list" class="ibm-data-table ibm-sortable-table ibm-alternating tablesorter tablesorter-default" summary="AltPurchase Comfirmation" id="row" cellspacing="1" cellpadding="0">
