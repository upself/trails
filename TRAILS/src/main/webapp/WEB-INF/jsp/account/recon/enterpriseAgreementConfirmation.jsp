...
assets with installed software matching those listed.  Due to the potential
volume of updates in the request, it may take more than a few minutes. Please
...
<s:form action="applyManualRecon" namespace="/account/recon" theme="simple">
	...
	<div class="float-left" style="width:25%;">
		<label for="automated">Overwrite automated reconciliations:</label></div>
	...
	<div class="button-bar">
		<div class="buttons"><span class="button-blue">
			<s:submit value="Confirm" /><s:submit method="cancel" value="Cancel" />
		</span></div>
	</div>
</s:form>
<div class="clear"></div>
...
<div class="clear"></div>
<small>
	<display:table name="data.list" class="basic-table" summary="enterprise Agreement Confirmation"
