...
<div class="ibm-columns" style="width: 95%;">
	<div class="ibm-col-1-1" >
		...
		<br />
		<p>Choose which systems to mark as Covered by IBM Owned enterprise
			agreement and whether or not to overwrite both manual and automated
	...
	<div class="ibm-col-1-1">
		...
		<s:form action="showEnterpriseAgreementConfirmation" namespace="/account/recon" theme="simple">
			<table width="99%" padding="3px">
				...
				<tr>
					...
					<td><s:checkbox name="automated"
							label="automated" />Yes</td>
				</tr>
				<tr>
	...
	<div class="ibm-col-1-1" style="width:99%; overflow-x: auto">
		<small>
			<display:table name="list" class="ibm-data-table ibm-sortable-table ibm-alternating tablesorter tablesorter-default" summary="enterprise Agreement"
