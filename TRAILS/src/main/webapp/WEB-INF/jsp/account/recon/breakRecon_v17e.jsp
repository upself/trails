...
<div class="ibm-columns" style="width: 95%;">
	<div class="ibm-col-1-1" >
		...
		<br />
		<p>Choose which systems to break a reconciliations that have the
selected software products shown in the list below. When you are
finished, click on the "Next" button to be taken to a confirmation page.
Click on cancel to return to the workspace.</p>
	...
	<div class="ibm-col-1-1">
		...
		<s:form action="showBreakConfirmation?gotoV17e=y" namespace="/account/recon" theme="simple">
	...
	<div class="ibm-col-1-1" style="width:99%; overflow-x: auto">
		<small>
			<display:table name="list" class="ibm-data-table ibm-sortable-table ibm-alternating tablesorter tablesorter-default" summary="Break Recon"
