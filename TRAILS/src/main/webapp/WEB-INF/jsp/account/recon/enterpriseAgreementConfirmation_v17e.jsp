...
the request has completed.</p>
		...
		<s:form action="applyManualRecon?gotoV17e=y" namespace="/account/recon" theme="simple">
			<table width="99%">
				...
				<tr>
					...
					<td><s:property value="automated" /></td>
				</tr>
				<tr>
					<td><label for="manual">Overwrite manual reconciliations:</label></td>
					<td><s:property value="manual" /></td>
				</tr>
				<tr>
	...
	<div class="ibm-col-1-1">
		<small>
			<display:table name="data.list" class="ibm-data-table ibm-sortable-table ibm-alternating tablesorter tablesorter-default" summary="enterprise Agreement Confirmation" id="row" cellspacing="1" cellpadding="0">
