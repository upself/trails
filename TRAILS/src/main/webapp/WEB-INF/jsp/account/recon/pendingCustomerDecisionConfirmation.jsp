...
request against the database. If you selected to run on something other than
"SELECTED", your action will run on all of those assets with installed software
matching those listed. Due to the potential volume of updates in the request, it
may take more than a few minutes. Please do not close your browser or navigate
to another url while the process is completing. You will be presented with your
...
<s:form action="applyManualRecon" namespace="/account/recon"
	...
	<div class="float-left" style="width:75%;"><s:property value="runon" /></div>
	...
	<div class="float-left" style="width:75%;"><s:property value="manual" /></div>
...
<div class="hrule-dots"></div>
<div class="clear"></div>
<small><display:table name="data.list" class="basic-table" id="row" summary="pending Customer Decision Confirmation"
