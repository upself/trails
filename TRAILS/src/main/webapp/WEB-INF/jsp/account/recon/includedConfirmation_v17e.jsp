...
execute your request against the database. Due to the potential volume
...
the request has completed.</p>
	...
	<div class="ibm-col-1-1">
		...
		<s:form action="applyManualRecon?gotoV17e=y" namespace="/account/recon" theme="simple">
			<table width="99%" padding="3px">
				<tr>
					<td style="width: 25%"><label>Product:</label></td>
					<td>
						<s:property default="yo" value="recon.installedSoftware.software.softwareName" />
					</td>
				</tr>
				<tr>
	...
	<div class="ibm-col-1-1" style="width:99%; overflow-x: auto">
		<small>
			<display:table name="data.list" class="ibm-data-table ibm-sortable-table ibm-alternating tablesorter tablesorter-default" summary="inclued list confirmation" id="row" cellspacing="1" cellpadding="0">
