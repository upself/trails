...
<div class="ibm-columns" style="width: 95%;">
	<div class="ibm-col-1-1" >
		...
		<br />
		<p>Choose which systems to unassign and enter a comment. When you are finished,
...
to return to the workspace.</p>
	...
	<div class="ibm-col-1-1">
		...
		<s:form action="showUnassignConfirmation?gotoV17e=y" namespace="/account/recon" theme="simple">
	...
	<div class="ibm-col-1-1">
		<small>
			<display:table name="list" class="ibm-data-table ibm-sortable-table ibm-alternating tablesorter tablesorter-default" summary="unassign" id="row" cellspacing="1" cellpadding="0">
