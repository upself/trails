...
<div class="ibm-columns">
	...
	<p>This page displays data exceptions for hardware Box without processor.</p>
	...
	<div class="ibm-col-1-1">
		<table id="page" cellspacing="0" cellpadding="0" border="0" class="ibm-data-table ibm-alternating" summary="Hardware Box No Processor">
			<thead>
				<tr>
...
function searchData(){
	...
	$("#page").paginationTable('destroy').paginationTable({
		remote: {
			url: "${pageContext.request.contextPath}/ws/exceptions/HWNPRC/search",
			type: "POST",
			params: params,
		...
		orderColumns: ['id','hardwareLpar.name','hardwareLpar.hardware.serial','creationTime','hardwareLpar.hardware.processorCount','hardwareLpar.extId','assignee','id']
	}); 
};
function assignComments(type){
	
	var comments = $('#comments').val();
	var url = '${pageContext.request.contextPath}/ws/exceptions/HWNPRC/';
	var params = {};
