...
<div class="ibm-columns">
	...
	<div class="ibm-col-1-1">
		<table id="page" cellspacing="0" cellpadding="0" border="0" class="ibm-data-table ibm-alternating" summary="SW LPAR NO OS">
			<thead>
				<tr>
...
function searchData(){
	...
	$("#page").paginationTable('destroy').paginationTable({
		remote: {
			url: "${pageContext.request.contextPath}/ws/exceptions/NOOS/search",
			type: "POST",
			params: params,
...
function assignComments(type){
	...
	var url = '${pageContext.request.contextPath}/ws/exceptions/NOOS/';
	var params = {};
