...
<div class="ibm-columns">
	...
	<p> This page displays the data exception records for software components loaded via software discrepancy which have expired based on CNDB scan validity.</p>
	...
	<div class="ibm-col-1-1">
		<table id="page" cellspacing="0" cellpadding="0" border="0" class="ibm-data-table ibm-alternating" summary="SW DISCREPANCY EXPIRED">
			<thead>
				<tr>
					...
					<th scope="col" class="ibm-sort nobreak"><a href="javascript:void(0)"><span>SW Component Name</span><span class="ibm-icon"></span></a></th>
...
function assignComments(type){
	...
	var url = '${pageContext.request.contextPath}/ws/exceptions/SWDSCEXP/';
	var params = {};
