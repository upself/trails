...
<h1>HW LPAR NO CPU MODEL:<s:property
	value="account.name" />(<s:property value="account.account" />)</h1>
<p class="confidential">IBM Confidential</p>
<p>This page displays data exceptions for hardware lpar without
CPU Model.</p>
<br />
<s:if test="%{data.list.size>0}">
	...
	<s:form action="lparNCPMDL" method="post" theme="simple">
		...
		<display:table name="data" class="basic-table" id="row"
			summary="Hardware Lpar  No CPU Model"
			decorator="org.displaytag.decorator.TotalTableDecorator"
			cellspacing="2" cellpadding="0" requestURI="lparNCPMDL.htm">
