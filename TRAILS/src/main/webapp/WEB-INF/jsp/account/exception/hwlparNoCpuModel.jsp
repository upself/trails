...
<div class="ibm-columns">
	...
	<p>This page displays data exceptions for hardware lpar without CPU Model.</p>
	...
	<div class="ibm-col-1-1">
		<table id="page" cellspacing="0" cellpadding="0" border="0" class="ibm-data-table ibm-alternating" summary="HW LPAR NO CPU MODEL">
			<thead>
				<tr>
...
function searchData(){
	...
	$("#page").paginationTable('destroy').paginationTable({
		remote: {
			url: "${pageContext.request.contextPath}/ws/exceptions/NCPMDL/search",
			type: "POST",
			params: params,
...
function assignComments(type){
	...
	var url = '${pageContext.request.contextPath}/ws/exceptions/NCPMDL/';
	var params = {};
