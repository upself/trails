...
<div class="ibm-columns">
	...
	<p>This page displays data exceptions for software lpars without active installed software.</p>
	...
	<div class="ibm-col-1-1">
		<table id="page" cellspacing="0" cellpadding="0" border="0" class="ibm-data-table ibm-alternating" summary="SW LPAR NO SOFTWARE">
			<thead>
				<tr>
...
function searchData(){
	...
	$("#page").paginationTable('destroy').paginationTable({
		remote: {
			url: "${pageContext.request.contextPath}/ws/exceptions/NOSW/search",
			type: "POST",
			params: params,
...
function assignComments(type){
	...
	var url = '${pageContext.request.contextPath}/ws/exceptions/NOSW/';
	var params = {};
