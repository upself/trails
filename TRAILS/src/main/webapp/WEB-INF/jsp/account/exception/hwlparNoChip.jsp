...
<h1>Hardware Box No Chips:<s:property
...
<s:if test="%{data.list.size>0}">
	...
	<s:form action="lparHWNCHP" method="post" theme="simple">
		...
		<display:table name="data" class="basic-table" id="row"
			summary="Hardware Box  No Chip"
			decorator="org.displaytag.decorator.TotalTableDecorator"
			cellspacing="2" cellpadding="0" requestURI="lparHWNCHP.htm">
