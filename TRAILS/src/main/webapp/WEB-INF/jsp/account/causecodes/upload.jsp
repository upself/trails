...
TRAILS Cause Codes are used to document the root cause of an alert and the team(s) responsible for the next action to resolve the alert. The
standard global Cause Codes are not intended to replace rigorous review of open alerts and creation of action plans to resolve them; they are
concise text description. Consensus on the ownership of 'next action' should be reached between Asset Management and the team outside Asset
prior to assigning a Cause Code that indicates action is required outside Asset Management.
<br>
<br>
...
<div style="margin-left:10px;font-size:1em">
	a. Cause Code: Text of the Cause Code, prefaced by the alert
		...
		standard list!<br><br>
	b. CC Target Date: Target date for correcting the issues; ensure
		the cell is under date format (Excel: Format -> Cells -> Number tab,
		choose category 'Date'). Optional field.<br><br>
	c. CC Owner: Email address of the person or team (task ID)
		responsible for the next action to resolve the alert as specified by
		the Cause Code.<br><br>
	d. CC Change Date: Timestamp when the Cause Code was last
		changed. Automatically populated by TRAILS in format 2013-08-19
		20:54:15:913273.<br><br>
	e. CC Change Person: Email address of the person changing the
		Cause Code. Automatically populated by TRAILS in format
		lotusshortname@country.ibm.com.<br><br>
	f. Internal ID: Do not use! Automatically populated by TRAILS to
		help manage the data.<br><br>
</div>
