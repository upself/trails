...
*/
	...
	public void getAlertWithDefinedContractScopeReport(Account pAccount,
		...
		StringBuffer sb = new StringBuffer("SELECT " +
				...
				"WHERE VA.Customer_Id = :customerId AND  VA.Type = 'UNDEFINED_SCOPE' AND VA.Open = 1 and CC.alert_type_id=17 " +
		...
		//////////////
		//WIP to solve hardcoded number values usage for vCauseCodeSummary- 
		//".setParameter("alertTypeId", new Long(17)).getResultList()"
		//these hardcoded alert_type values will cause a lot of problems in the future, 
		//since the id is autogenerated, thus different across databases
		/////////////
