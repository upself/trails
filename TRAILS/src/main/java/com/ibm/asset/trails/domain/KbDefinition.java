...
public class KbDefinition extends AbstractDomainEntity {
	...
	public boolean equals(final Object other) {
		if (!(other instanceof KbDefinition))
			return false;
		KbDefinition castOther = (KbDefinition) other;
		return new EqualsBuilder().append(guid, castOther.guid).isEquals();
	}

	@Override
	public int hashCode() {
		return new HashCodeBuilder().append(guid).toHashCode();
	}
}
