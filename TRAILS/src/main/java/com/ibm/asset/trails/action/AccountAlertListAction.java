...
@Action("alertList")
@Results({ @Result(name = ActionSupport.SUCCESS, location = "/WEB-INF/jsp/account/reports/alertReportList.jsp") })
public class AccountAlertListAction extends AccountBaseAction {	
	/**
	 * 
	 */
	private static final long serialVersionUID = 4195045740990851242L;
	@Autowired
