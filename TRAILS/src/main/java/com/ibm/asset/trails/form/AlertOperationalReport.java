...
public class AlertOperationalReport {
	...
	public AlertOperationalReport(String name, Long id, String alertName,
	...
	public AlertOperationalReport(String name, Long accountNumber, Long id,
	...
	public AlertOperationalReport(String name, String alertName, Long redSum,
			Long yellowSum, Long greenSum, Long assetSum) {
		this.name = name;
		this.alertName = alertName;
		this.redSum = redSum;
