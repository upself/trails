...
@NamedQueries({
		...
		@NamedQuery(name = "getSectorReport", query = "SELECT new com.ibm.asset.trails.form.DataExceptionReportActionForm(s.id, s.name, sum(case when a.assignee!=null then 1 else 0 end) as assigned, COUNT(*), a.alertType) FROM  DataException a inner join a.account.industry.sector s where a.open=1 GROUP BY s.id, s.name, a.alertType"),
		@NamedQuery(name = "getSectorReportByGeographyRegionCountryCode", query = "SELECT new com.ibm.asset.trails.form.DataExceptionReportActionForm(s.id, s.name, sum(case when a.assignee!=null then 1 else 0 end) as assigned, COUNT(*), a.alertType)FROM  DataException a inner join a.account.industry.sector s where a.open=1 and a.account.countryCode.region.geography =:geography and a.account.countryCode.region=:region and a.account.countryCode=:countryCode GROUP BY s.id, s.name, a.alertType"),
		@NamedQuery(name = "getSectorReportByGeographyRegion", query = "SELECT new com.ibm.asset.trails.form.DataExceptionReportActionForm(s.id, s.name, sum(case when a.assignee!=null then 1 else 0 end) as assigned, COUNT(*), a.alertType) FROM  DataException a inner join a.account.industry.sector s where a.open=1 and a.account.countryCode.region.geography =:geography and a.account.countryCode.region=:region GROUP BY s.id, s.name, a.alertType"),
		@NamedQuery(name = "getSectorReportByGeographyCountryCode", query = "SELECT new com.ibm.asset.trails.form.DataExceptionReportActionForm(s.id, s.name, sum(case when a.assignee!=null then 1 else 0 end) as assigned, COUNT(*), a.alertType) FROM  DataException a inner join a.account.industry.sector s where a.open=1 and a.account.countryCode.region.geography =:geography and a.account.countryCode=:countryCode GROUP BY s.id, s.name, a.alertType"),
		@NamedQuery(name = "getSectorReportByRegionCountryCode", query = "SELECT new com.ibm.asset.trails.form.DataExceptionReportActionForm(s.id, s.name, sum(case when a.assignee!=null then 1 else 0 end) as assigned, COUNT(*), a.alertType) FROM  DataException a inner join a.account.industry.sector s where a.open=1 and a.account.countryCode.region=:region and a.account.countryCode=:countryCode GROUP BY s.id, s.name, a.alertType"),
		@NamedQuery(name = "getSectorReportByGeography", query = "SELECT new com.ibm.asset.trails.form.DataExceptionReportActionForm(s.id, s.name, sum(case when a.assignee!=null then 1 else 0 end) as assigned, COUNT(*), a.alertType)FROM  DataException a inner join a.account.industry.sector s where a.open=1 and a.account.countryCode.region.geography =:geography GROUP BY s.id, s.name, a.alertType"),
		@NamedQuery(name = "getSectorReportByRegion", query = "SELECT new com.ibm.asset.trails.form.DataExceptionReportActionForm(s.id, s.name, sum(case when a.assignee!=null then 1 else 0 end) as assigned, COUNT(*), a.alertType) FROM  DataException a inner join a.account.industry.sector s where a.open=1 and a.account.countryCode.region=:region GROUP BY s.id, s.name, a.alertType"),
		@NamedQuery(name = "getSectorReportByCountryCode", query = "SELECT new com.ibm.asset.trails.form.DataExceptionReportActionForm(s.id, s.name, sum(case when a.assignee!=null then 1 else 0 end) as assigned, COUNT(*), a.alertType) FROM  DataException a inner join a.account.industry.sector s where a.open=1 and a.account.countryCode=:countryCode GROUP BY s.id, s.name, a.alertType"),
		...
		@NamedQuery(name = "getAccountReportByGeographyRegionCountryCodeSector", query = "SELECT new com.ibm.asset.trails.form.DataExceptionReportActionForm(a.account, sum(case when a.assignee!=null then 1 else 0 end) as assigned, COUNT(*), a.alertType) FROM  DataException a inner join a.account c where a.open=1 and a.account.countryCode.region.geography =:geography and a.account.countryCode.region=:region and a.account.countryCode=:countryCode and a.account.industry.sector = :sector GROUP BY a.account, a.alertType"),
		...
		@NamedQuery(name = "getAccountReportByGeographyRegionSector", query = "SELECT new com.ibm.asset.trails.form.DataExceptionReportActionForm(a.account, sum(case when a.assignee!=null then 1 else 0 end) as assigned, COUNT(*), a.alertType) FROM  DataException a inner join a.account c where a.open=1 and a.account.countryCode.region.geography =:geography and a.account.countryCode.region=:region and a.account.industry.sector = :sector GROUP BY a.account, a.alertType"),
		...
		@NamedQuery(name = "getAccountReportByRegionCountryCodeSector", query = "SELECT new com.ibm.asset.trails.form.DataExceptionReportActionForm(a.account, sum(case when a.assignee!=null then 1 else 0 end) as assigned, COUNT(*), a.alertType) FROM  DataException a inner join a.account c where a.open=1 and a.account.countryCode.region=:region and a.account.countryCode=:countryCode and a.account.industry.sector = :sector GROUP BY a.account, a.alertType"),
		...
		@NamedQuery(name = "getAccountReportByGeographyCountryCodeSector", query = "SELECT new com.ibm.asset.trails.form.DataExceptionReportActionForm(a.account, sum(case when a.assignee!=null then 1 else 0 end) as assigned, COUNT(*), a.alertType) FROM  DataException a inner join a.account c where a.open=1 and a.account.countryCode.region.geography =:geography and a.account.countryCode=:countryCode and a.account.industry.sector = :sector GROUP BY a.account, a.alertType"),
		...
		@NamedQuery(name = "getAccountReportByCountryCodeSector", query = "SELECT new com.ibm.asset.trails.form.DataExceptionReportActionForm(a.account, sum(case when a.assignee!=null then 1 else 0 end) as assigned, COUNT(*), a.alertType) FROM  DataException a inner join a.account c where a.open=1 and a.account.countryCode=:countryCode and a.account.industry.sector = :sector GROUP BY a.account, a.alertType"),
		...
		@NamedQuery(name = "getAccountReportByRegionSector", query = "SELECT new com.ibm.asset.trails.form.DataExceptionReportActionForm(a.account, sum(case when a.assignee!=null then 1 else 0 end) as assigned, COUNT(*), a.alertType) FROM  DataException a inner join a.account c where a.open=1 and a.account.countryCode.region=:region and a.account.industry.sector = :sector GROUP BY a.account, a.alertType"),
		...
		@NamedQuery(name = "getAccountReportByGeographySector", query = "SELECT new com.ibm.asset.trails.form.DataExceptionReportActionForm(a.account, sum(case when a.assignee!=null then 1 else 0 end) as assigned, COUNT(*), a.alertType) FROM  DataException a inner join a.account c where a.open=1 and a.account.countryCode.region.geography =:geography and a.account.industry.sector = :sector GROUP BY a.account, a.alertType"),
		...
		@NamedQuery(name = "getAccountReportBySector", query = "SELECT new com.ibm.asset.trails.form.DataExceptionReportActionForm(a.account, sum(case when a.assignee!=null then 1 else 0 end) as assigned, COUNT(*), a.alertType) FROM  DataException a inner join a.account c where a.open=1 and a.account.industry.sector = :sector GROUP BY a.account, a.alertType"),
