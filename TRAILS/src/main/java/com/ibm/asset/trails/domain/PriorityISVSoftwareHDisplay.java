...
public class PriorityISVSoftwareHDisplay {
	...
	public PriorityISVSoftwareHDisplay() {
	}

	public PriorityISVSoftwareHDisplay(Long id, Long priorityISVSoftwareId, String level,
