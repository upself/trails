...
public class VSoftwareLparDAOJpaTest {
	...
	//Testing Data
	private final static String MANUFACTURER_NAME  = "IBM";
    ...
    public void testGetScheduleFItem4ManufacturerLevel() {
    	...
    	ScheduleF scheduleF = vSoftwareLparDAO.getScheduleFItem(account, SOFTWARE_NAME, HOSTNAME, HW_OWNER, HWBOX_MACHINE_TYPE, HWBOX_SERIAL, MANUFACTURER_NAME);
