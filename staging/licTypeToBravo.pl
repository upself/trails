...
use File::Copy;
use Base::Utils;
use BRAVO::LicenseTypeLoader;
use Base::ConfigManager;
use Tap::NewPerl; 

###Globals
my $logfile       = "/var/staging/logs/licTypeToBravo/licTypeToBravo.log";
my $pidFile       = "/tmp/licTypeDataToBravo.pid";
my $configFile          = "/opt/staging/v2/config/licTypeToBravoConfig.txt";
...
eval {
	...
	while (1) {
		...
		###Load cap type data
		$loader = new BRAVO::LicenseTypeLoader();
		$loader->load(
			TestMode      => $testMode,
