...
use Tap::NewPerl;
### example: 
### nohup ./reconEngineInventoryCustomerChild.pl -t 0 -a 1 -c 504 -d 12/31/2012 -p 0 -l /var/staging/logs/reconEngineInventory/reconEngineInventory.log.child.504  -f /opt/staging/v2/config/reconEngineInventoryConfig.txt &
###Check usage.
...
eval {
 ...
 my $reconEngine =
   new Recon::InventoryReconEngineCustomer( $opt_c, $opt_d, $opt_p );
 $reconEngine->recon;
