package Test::Common::MockConnection;
...
sub setDBInfo {
    ...
    if ( $self->bankAccount->isa("Sigbank::OM::BankAccount") ) {
        ...
        $dbs{'swasset'}{'password'} = 'july01db2';
        $dbs{'swasset'}{'user'}     = 'swasset';
        $dbs{'swasset'}{'name'}     = 'SWASSET';
        ...
        $dbs{'trails'}{'password'} = 'apr03db2';
        $dbs{'trails'}{'user'}     = 'eaadmin';
        $dbs{'trails'}{'name'}     = 'PTRAILS';

        $dbs{'t2trails'}{'password'} = 'apr03db2';
        $dbs{'t2trails'}{'user'}     = 'eaadmin';
        $dbs{'t2trails'}{'name'}     = 'TRAILS';

        $dbs{'cndb'}{'password'} = 'jun26db2';
        $dbs{'cndb'}{'user'}     = 'cndb';
        $dbs{'cndb'}{'name'}     = 'CNDB';

        $dbs{'swcm'}{'password'} = 'apr03db2';
        $dbs{'swcm'}{'user'}     = 'eaadmin';
        $dbs{'swcm'}{'name'}     = 'TRAILS';
