package integration::reconEngine::CmdDeleteScheduleFOnHostname;
...
sub execute {
 ...
 $self->connection->prepareSqlQuery( 'queryCmdDeleteScheduleFOnHostname', $sql );
 my $sth = $self->connection->sql->{queryCmdDeleteScheduleFOnHostname};
