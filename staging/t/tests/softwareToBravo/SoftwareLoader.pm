...
sub getKbDefinitionIdByGUID : Tests(10) {
	...
	pass("Semi online test - !! If test fails, check test expected results and data from TRAILS first.!!");
     ...
     is($class->getKbDefinitionIdByGUID($connection,'c50423ad00d1ef79442da2c2afcec67f'),'472702','getKbDefinitionIdByGUID -> guid: c582e4809e71925054906bdd2d9002ad - MF_Id: 472651');
     
     is($class->getKbDefinitionIdByGUID($connection,'c582e4809e71925054906bdd2d9002ad'),'469679','getKbDefinitionIdByGUID -> guid: e40bc664b22d8e9461275ff4516dfd66 - MV_Id: 469679');
     is($class->getKbDefinitionIdByGUID($connection,'e40bc664b22d8e9461275ff4516dfd66'),'472651','getKbDefinitionIdByGUID -> guid: c4cd23ace3b0fc3e492ec3b293b3e39d - MV_Id: 472651');
