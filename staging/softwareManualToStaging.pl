...
###Globals
my $logfile =
  "/var/staging/logs/softwareManualToStaging/softwareManualToStaging.log";
my $pidFile             = "/tmp/softwareManualToStaging.pid";
my $configFile          = "/opt/staging/v2/config/softwareManualToStagingConfig.txt";
