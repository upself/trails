...
###Globals
my $logfile =
  "/var/staging/logs/softwareTlcmzToStaging/softwareTlcmzToStaging.log";
my $pidFile             = "/tmp/softwareTlcmzToStaging.pid";
my $configFile          = "/opt/staging/v2/config/softwareTlcmzToStagingConfig.txt";
