...
GRANT DELETE ON TABLE "EAADMIN "."SCARLET_RECONCILE"           TO GROUP "TRAILPRD" ;    
GRANT INSERT ON TABLE "EAADMIN "."SCARLET_RECONCILE"           TO GROUP "TRAILPRD" ;    
GRANT SELECT ON TABLE "EAADMIN "."SCARLET_RECONCILE"           TO GROUP "TRAILPRD" ;    
GRANT UPDATE ON TABLE "EAADMIN "."SCARLET_RECONCILE"           TO GROUP "TRAILPRD" ; 

GRANT REFERENCES ON TABLE "EAADMIN "."SCARLET_RECONCILE"       TO USER eaadmin ;   
GRANT DELETE ON TABLE "EAADMIN "."SCARLET_RECONCILE"           TO USER eaadmin ;   
GRANT INSERT ON TABLE "EAADMIN "."SCARLET_RECONCILE"           TO USER eaadmin ;   
GRANT SELECT ON TABLE "EAADMIN "."SCARLET_RECONCILE"           TO USER eaadmin ;   
GRANT UPDATE ON TABLE "EAADMIN "."SCARLET_RECONCILE"           TO USER eaadmin ; 