...
INSERT INTO ASN.IBMSNAP_SUBS_COLS ( 
 ...
 )SELECT 'PD_TO_RP_QUAL', 'RPREP1', 'S', 'EAADMIN', 'HARDWARE', 'MULTI_TENANT', 'A', 'N', MAX(COLNO + 1), 'MULTI_TENANT' 
 ...
 TARGET_OWNER, TARGET_TABLE, TARGET_NAME, 
 COL_TYPE, IS_KEY, COLNO, EXPRESSION 
 )SELECT 'PD_TO_RP_QUAL', 'RPREP1', 'S', 'EAADMIN', 'HARDWARE', 'HARDWARE_COMPLEX', 'A', 'N', MAX(COLNO + 1), 'HARDWARE_COMPLEX' 
 FROM ASN.IBMSNAP_SUBS_COLS  WHERE APPLY_QUAL='PD_TO_RP_QUAL' AND SET_NAME='RPREP1' AND WHOS_ON_FIRST='S' AND 
 TARGET_OWNER='EAADMIN' AND TARGET_TABLE='HARDWARE';