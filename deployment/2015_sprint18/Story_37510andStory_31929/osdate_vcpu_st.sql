...
INSERT INTO ASN.IBMSNAP_SUBS_COLS (APPLY_QUAL, SET_NAME , 
 ...
 SELECT 'PD_TO_ST_QUAL','STREP1','S','EAADMIN','HARDWARE_LPAR','A', 
 'VCPU','N', MAX(COLNO + 1),'VCPU' 
FROM ASN.IBMSNAP_SUBS_COLS 
 WHERE APPLY_QUAL='PD_TO_ST_QUAL' AND SET_NAME='STREP1' AND WHOS_ON_FIRST='S' AND 
 TARGET_OWNER='EAADMIN' AND TARGET_TABLE='HARDWARE_LPAR' 
 ;
...
;
GRANT SELECT ON TABLE "EAADMIN "."MQT_ALERT_REPORT"          TO GROUP "TRAILSTG" ; 
GRANT SELECT ON "EAADMIN"."MQT_ALERT_REPORT" TO USER EAADMIN
;
