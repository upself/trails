...
GRANT REFERENCES ON TABLE "EAADMIN "."NON_INSTANCE"      TO GROUP "TRAILRPT" ; 
GRANT SELECT ON TABLE "EAADMIN "."NON_INSTANCE"          TO GROUP "TRAILRPT" ;      
GRANT REFERENCES ON TABLE "EAADMIN "."NON_INSTANCE"      TO USER eaadmin ;       
GRANT SELECT ON TABLE     "EAADMIN "."NON_INSTANCE"      TO USER eaadmin ; 
-------- Privilege for Non_instance_h --------    
GRANT REFERENCES ON TABLE "EAADMIN "."NON_INSTANCE_H"    TO GROUP "TRAILRPT" ; 
GRANT SELECT ON TABLE     "EAADMIN "."NON_INSTANCE_H"    TO GROUP "TRAILRPT" ;                                                                                                                                                                   
GRANT REFERENCES ON TABLE "EAADMIN "."NON_INSTANCE_H"    TO  USER eaadmin ;       
GRANT SELECT ON TABLE     "EAADMIN "."NON_INSTANCE_H"    TO  USER eaadmin ;   
