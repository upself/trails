...
GRANT DELETE ON TABLE "EAADMIN "."NON_INSTANCE"           TO GROUP "TRAILPRD" ;    
GRANT INSERT ON TABLE "EAADMIN "."NON_INSTANCE"           TO GROUP "TRAILPRD" ;    
GRANT SELECT ON TABLE "EAADMIN "."NON_INSTANCE"           TO GROUP "TRAILPRD" ;    
GRANT UPDATE ON TABLE "EAADMIN "."NON_INSTANCE"           TO GROUP "TRAILPRD" ; 

GRANT REFERENCES ON TABLE "EAADMIN "."NON_INSTANCE"       TO USER eaadmin ;   
GRANT DELETE ON TABLE "EAADMIN "."NON_INSTANCE"           TO USER eaadmin ;   
GRANT INSERT ON TABLE "EAADMIN "."NON_INSTANCE"           TO USER eaadmin ;   
GRANT SELECT ON TABLE "EAADMIN "."NON_INSTANCE"           TO USER eaadmin ;   
GRANT UPDATE ON TABLE "EAADMIN "."NON_INSTANCE"           TO USER eaadmin ;  
 ------ Privilege For NON_INSTANCE_H ------------
GRANT REFERENCES ON TABLE "EAADMIN "."NON_INSTANCE_H"     TO  GROUP "TRAILUPD";   
GRANT DELETE ON TABLE "EAADMIN "."NON_INSTANCE_H"         TO  GROUP "TRAILPRD";    
GRANT INSERT ON TABLE "EAADMIN "."NON_INSTANCE_H"         TO  GROUP "TRAILPRD";    
GRANT SELECT ON TABLE "EAADMIN "."NON_INSTANCE_H"         TO  GROUP "TRAILPRD";    
GRANT UPDATE ON TABLE "EAADMIN "."NON_INSTANCE_H"         TO  GROUP "TRAILPRD";  


GRANT REFERENCES ON TABLE "EAADMIN "."NON_INSTANCE_H"     TO USER eaadmin ;    
GRANT DELETE ON TABLE "EAADMIN "."NON_INSTANCE_H"         TO  USER eaadmin ;  
GRANT INSERT ON TABLE "EAADMIN "."NON_INSTANCE_H"         TO  USER eaadmin ;  
GRANT SELECT ON TABLE "EAADMIN "."NON_INSTANCE_H"         TO  USER eaadmin ;  
GRANT UPDATE ON TABLE "EAADMIN "."NON_INSTANCE_H"         TO  USER eaadmin ;  
