...
GRANT REFERENCES ON TABLE "EAADMIN "."REPORT_DELIVERY_TRACKING"      TO GROUP "TRAILRPT" ; 
GRANT SELECT ON TABLE "EAADMIN "."REPORT_DELIVERY_TRACKING"          TO GROUP "TRAILRPT" ;      
...
GRANT REFERENCES ON TABLE "EAADMIN "."REPORT_DELIVERY_TRACKING_H"    TO GROUP "TRAILRPT" ; 
GRANT SELECT ON TABLE     "EAADMIN "."REPORT_DELIVERY_TRACKING_H"    TO GROUP "TRAILRPT" ;                                                                                                                                                                   
