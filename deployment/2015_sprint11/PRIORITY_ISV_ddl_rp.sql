...
GRANT REFERENCES ON TABLE "EAADMIN "."PRIORITY_ISV_SW"      TO GROUP "TRAILRPT" ; 
GRANT SELECT ON TABLE "EAADMIN "."PRIORITY_ISV_SW"          TO GROUP "TRAILRPT" ;      
...
GRANT REFERENCES ON TABLE "EAADMIN "."PRIORITY_ISV_SW_H"    TO GROUP "TRAILRPT" ; 
GRANT SELECT ON TABLE     "EAADMIN "."PRIORITY_ISV_SW_H"    TO GROUP "TRAILRPT" ;                                                                                                                                                                   
