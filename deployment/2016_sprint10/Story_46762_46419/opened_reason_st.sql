...
INSERT INTO ASN.IBMSNAP_SUBS_COLS ( 
 ...
 )SELECT 'PD_TO_ST_QUAL', 'STREP1', 'S', 'EAADMIN', 'ALERT_UNLICENSED_SW', 'OPENED_REASON', 'A', 'N', MAX(COLNO + 1), 'OPENED_REASON' 
 ...
 TARGET_OWNER, TARGET_TABLE, TARGET_NAME, 
 COL_TYPE, IS_KEY, COLNO, EXPRESSION 
 )SELECT 'PD_TO_ST_QUAL', 'STREP1', 'S', 'EAADMIN', 'ALERT_UNLICENSED_SW_H', 'OPENED_REASON', 'A', 'N', MAX(COLNO + 1), 'OPENED_REASON' 
 FROM ASN.IBMSNAP_SUBS_COLS  WHERE APPLY_QUAL='PD_TO_ST_QUAL' AND SET_NAME='STREP1' AND WHOS_ON_FIRST='S' AND 
