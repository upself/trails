...
;		
GRANT REFERENCES ON EAADMIN.MQT_OP_METRICS_SWTRACKING TO GROUP TRAILPRD		
;		
GRANT SELECT ON EAADMIN.MQT_OP_METRICS_SWTRACKING TO GROUP TRAILPRD		
;		
GRANT REFERENCES ON EAADMIN.MQT_OP_METRICS_SWTRACKING TO GROUP TRAILUPD		
;		
GRANT SELECT ON EAADMIN.MQT_OP_METRICS_SWTRACKING TO GROUP TRAILUPD
;
