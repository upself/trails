...
update EAADMIN.ALERT_TYPE set NAME = 'SOM1a: HW WITH HOSTNAME' where CODE = 'HARDWARE';
...
update EAADMIN.ALERT_TYPE set NAME = 'SOM1b: HW BOX CRITICAL CONFIGURATION DATA POPULATED' where CODE = 'HWCFGDTA';
...
update EAADMIN.ALERT_TYPE set NAME = 'SOM2a: HW LPAR WITH SW LPAR' where CODE = 'HW_LPAR';
...
update EAADMIN.ALERT_TYPE set NAME = 'SOM2b: SW LPAR WITH HW LPAR' where CODE = 'SW_LPAR';

--Update the name of alert type which code is 'EXP_SCAN'(Alert Type Id = 6) from 'OUTDATED SW LPAR' to 'SOM2c: UNEXPIRED SW LPAR'
update EAADMIN.ALERT_TYPE set NAME = 'SOM2c: UNEXPIRED SW LPAR' where CODE = 'EXP_SCAN';
...
update EAADMIN.ALERT_TYPE set NAME = 'SOM3: SW INSTANCES WITH DEFINED CONTRACT SCOPE' where CODE = 'SWISCOPE';
...
update EAADMIN.ALERT_TYPE set NAME = 'SOM4a: IBM SW INSTANCES REVIEWED' where CODE = 'SWIBM';
...
update EAADMIN.ALERT_TYPE set NAME = 'SOM4b: PRIORITY ISV SW INSTANCES REVIEWED' where CODE = 'SWISVPR';
...
update EAADMIN.ALERT_TYPE set NAME = 'SOM4c: ISV SW INSTANCES REVIEWED' where CODE = 'SWISVNPR';