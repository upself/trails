package IBM::Schema::CNDB::VRevalCustomerNumber;
...
__PACKAGE__->table("V_REVAL_CUSTOMER_NUMBER");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:RYJUpoPO//lH4rO1DC4fiw
