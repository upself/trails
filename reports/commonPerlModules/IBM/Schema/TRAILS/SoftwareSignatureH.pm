package IBM::Schema::TRAILS::SoftwareSignatureH;
...
__PACKAGE__->add_unique_constraint("IF2SWSIGNATUREH", ["software_signature_h_id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:uoQSD5xI9P2d/ssKK6jWdA
