package IBM::Schema::TRAILS::SoftwareH;
...
__PACKAGE__->add_unique_constraint("IF1SOFTWAREH", ["software_h_id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:lheysV8Cdon8QHvwkxiYrA
