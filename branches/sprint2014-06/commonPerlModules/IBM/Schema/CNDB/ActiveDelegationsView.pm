package IBM::Schema::CNDB::ActiveDelegationsView;
...
__PACKAGE__->table("ACTIVE_DELEGATIONS_VIEW");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:atMmCHMXzMaHiKbMPvLTDw
