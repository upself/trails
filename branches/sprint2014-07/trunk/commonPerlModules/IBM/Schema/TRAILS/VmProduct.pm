package IBM::Schema::TRAILS::VmProduct;
...
__PACKAGE__->add_unique_constraint("IF1VMPRODUCT", ["id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:eIy7l0rFUhzg1UWKZaTgKw
