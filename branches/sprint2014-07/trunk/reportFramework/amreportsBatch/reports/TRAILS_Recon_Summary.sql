select
software_name
,count(software_name) as product_count
,sum(processor_count) as processor_count
,sum(quantity) as quantity
,license_type
,(sum(quantity) - sum(processor_count)) as delta
from (
select 
node_name
,serial_number
...
group by software_name, license_type