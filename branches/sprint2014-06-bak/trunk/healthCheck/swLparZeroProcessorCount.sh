...
DIFFBRAVO=$TMPDIR/swLparZeroProcessorCount.txt
...
db2 export to $EXPORTBRAVO of del \
    ...
    "select \
     ...
     where \
        ...
        and ( (sle.processor_count is not null and sl.processor_count + sle.processor_count = 0) \
            or (sle.processor_count is null and sl.processor_count = 0) ) \
    with ur"
