package IBM::Schema::TRAILS::AlertHardwareH;
...
__PACKAGE__->add_unique_constraint("IF1ALERTHARDWAREH", ["id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Qnw//UEB7gR54UUe9LnzaA
