 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class MassLoadSignatureBatch extends BatchBase implements IBatch,
		Serializable {
	/**
	 * 
	 */
	...
	private static final Logger logger = Logger
			.getLogger(MassLoadSignatureBatch.class);
	...
	public MassLoadSignatureBatch(String remoteUser, String fileName,
	...
	public void execute() {
		...
		logger.debug("starting batch loader for signature load");
		...
		try {
			...
			Validator val = new Validator(valRes, "/MassSoftwareSignatureSave");
			...
			while ((str = in.readLine()) != null) {
				...
				msgs = SoftwareSignatureDelegate.massLoadSignatures(str, val,
						valRes, remoteUser, i);
	...
	public void printMessage(String str, StringBuffer message, int row) {
		message.append("STATUS [" + row + "]: " + str);
	}

	public void printError(String str, StringBuffer message, int row) {
		message.append("ERROR [" + row + "]: " + str);
	}
}