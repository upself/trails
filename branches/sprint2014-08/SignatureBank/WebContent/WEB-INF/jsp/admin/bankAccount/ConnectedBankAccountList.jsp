...
<display:table id="row" name="report" class="bravo" defaultsort="2"
	...
	<display:column title="Name" property="name" headerClass="blue-med"
		href="UpdateConnectedBankAccount.do" paramId="id" paramProperty="id"
		sortable="true" />
	...
	<display:column title="Connection Status" headerClass="blue-med"
		property="connectionStatus" href="BankAccountStatusDetail.do"
		paramId="id" paramProperty="id" sortable="true" />
</display:table>
