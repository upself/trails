...
<h1>New Manufacturer Request Form</h1>
<br>
<p>Use this form to request a new manufacturer. When you are
...
<html:form action="/AddManufacturerSave">
	<table cellspacing="0" cellpadding="0" class="sign-in-table">
		<tr>
			...
			<html:text styleId="manufacturerName" property="manufacturerName" styleClass="input" size="128" /></td>
		</tr>
		<tr>
