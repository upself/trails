...
<h1>Update Manufacturer Request Form</h1>
<br>
<p>Use this form to update a manufacturer. When you are finished,
...
<html:form action="/UpdateManufacturerSave">
	<html:hidden property="manufacturerId" />
	<table cellspacing="0" cellpadding="0" class="sign-in-table">
		<tr>
			<td class="t1"><label for="manufacturerName">*Manufacturer
			Name:</label></td>
			<td>
			<div class="input-note">maximum 64 characters</div>
			<html:text styleId="manufacturerName" property="manufacturerName" styleClass="input" size="64" /></td>
		</tr>
		<tr>
			<td class="t1">*<label for="status">Status</label>:</td>
			<td>
			<div class="input-note">choose one</div>
			<html:select styleId="status" property="status" styleClass="input">
...
<display:table name="manufacturerHistory" class="bravo" defaultsort="10"
