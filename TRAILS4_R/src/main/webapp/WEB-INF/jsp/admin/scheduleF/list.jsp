...
<display:table 
	...
	defaultsort="1" 
	export="true" >
	<display:setProperty name="export.excel.filename" value="SheduleF_View.xls" />
		
	<display:column property="account.account" title="Account Number" media="excel" />
	<display:column 
		property="softwareName"
		sortProperty="SF.softwareName"
		title="Software name" 
		sortable="true"
		href="/TRAILS/admin/scheduleF/manage.htm" 
		paramProperty="id"
		paramId="scheduleFId" 
		media="html" />
	<display:column 
		property="softwareTitle" 
		sortProperty="SF.softwareTitle"
		title="Software title" 
		sortable="true" 
		media="html" />
	<display:column property="softwareTitle" title="Software title" media="excel" />	
	<display:column property="softwareName" title="Software name" media="excel" />	
	<display:column 
		property="manufacturer" 
		sortProperty="SF.manufacturer"
		title="Manufacturer" 
		sortable="true" />
	<display:column 
		property="scope.description"
		sortProperty="SF.scope.description" 
		title="Scope" 
		sortable="true" />
	<display:column 
		property="source.description"
		sortProperty="SF.source.description" 
		title="Source" 
		sortable="true" />
	<display:column 
		property="sourceLocation" 
		sortProperty="SF.sourceLocation"
		title="Source location" 
		sortable="true" />
	<display:column 
		property="status.description"
		sortProperty="SF.status.description" 
		title="Status" 
		sortable="true" />
	<display:column 
