...
<h1>Active SW LPAR without Customer:<s:property
...
<s:if test="%{data.list.size>0}">
	...
	<s:form action="swlparNOCUST" method="post" theme="simple">
		...
		<display:table name="data" class="basic-table" id="row"
			summary="SoftwareLpar No Customer"
			decorator="org.displaytag.decorator.TotalTableDecorator"
			cellspacing="2" cellpadding="0" requestURI="swlparNOCUST.htm">
