...
<h1>Active SW LPAR with zero processor/effective processor counts:<s:property
	value="account.name" />(<s:property value="account.account" />)</h1>
<p class="confidential">IBM Confidential</p>
<br />
<p>This page displays data exceptions for software lpars with zero
processor/effective processor counts.</p>
...
<s:if test="%{data.list.size>0}">
	...
	<s:form action="swlparZEROPROC" method="post" theme="simple">
		...
		<display:table name="data" class="basic-table" id="row"
			summary="SoftwareLpar No Processor"
			decorator="org.displaytag.decorator.TotalTableDecorator"
			cellspacing="2" cellpadding="0" requestURI="swlparZEROPROC.htm">
