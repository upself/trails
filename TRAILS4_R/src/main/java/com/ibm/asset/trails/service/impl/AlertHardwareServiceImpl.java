...
public class AlertHardwareServiceImpl extends BaseAlertServiceImpl implements
    ...
    public void updateAll(Account pAccount, String psRemoteUser,
        ...
        lqUpdateAll.setParameter("alertHardwareIdList", llAlertHardwareIdList);
        llAlertHardware = lqUpdateAll.getResultList();
        for (AlertHardware lahTemp : llAlertHardware) {
