...
###Globals
my $logfile =
  "/var/staging/logs/scanSoftwareItemToStaging/scanSoftwareItemToStaging.log";
my $pidFile             = "/tmp/scanSoftwareItemToStaging.pid";
my $configFile          = "/opt/staging/v2/config/scanSoftwareItemToStagingConfig.txt";
