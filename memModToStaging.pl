...
###Globals
my $logfile    = "/var/staging/logs/memModToStaging/memModToStaging.log";
my $pidFile    = "/tmp/memModToStaging.pid";
my $configFile = "/opt/staging/v2/config/memModToStagingConfig.txt";
