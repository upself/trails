...
my $logfile         = "/var/staging/logs/ipAddressToBravo/ipAddressToBravo.log";
my $pidFile         = "/tmp/ipAddressToBravo.pid";
my $configFile      = "/opt/staging/v2/config/ipAddressToBravoConfig.txt";
...
my $job = 'IP ADDRESS STAGING TO BRAVO';
my $job1;
