...
sub p1Query {
 ...
 $query .= ' where a.customer_id in (
     337,414,479,503,514,532,758,1034,1206,1471,2568,2605,2676,
     2692,2876,2928,2963,2981,2991,3947,5825,7049,7160,7199,7649,
     7651,8621,9102,9204,9206,9514,9754,11034,11472,11804,11860,
     12350,12476,12496,13792,14075,14182,14536,14543,14939,15246
    )
    and (
        a.action != \'COMPLETE\'
