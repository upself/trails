...
###Globals
my $logfile    = "/var/staging/logs/softwareFilterToStaging/softwareFilterToStaging.log";
my $pidFile    = "/tmp/softwareFilterToStaging.pid";
my $configFile = "/opt/staging/v2/config/softwareFilterToStagingConfig.txt";
