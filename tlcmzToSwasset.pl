...
###Globals
my $logfile          = "/var/staging/logs/tlcmzToSwasset/tlcmzToSwasset.log";
my $pidFile          = "/tmp/tlcmzToSwasset.pid";
my $configFile          = "/opt/staging/v2/config/tlcmzToSwassetConfig.txt";
...
my $scanFilesRootDir = '/var/ftp/mf_scan/perm';
