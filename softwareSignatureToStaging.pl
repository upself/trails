...
###Globals
my $logfile    = "/var/staging/logs/softwareSignatureToStaging/softwareSignatureToStaging.log";
my $pidFile    = "/tmp/softwareSignatureToStaging.pid";
my $configFile = "/opt/staging/v2/config/softwareSignatureToStagingConfig.txt";
