...
###Globals
my $logfile    = "/var/staging/logs/processorToStaging/processorToStaging.log";
my $pidFile    = "/tmp/processorToStaging.pid";
my $configFile = "/opt/staging/v2/config/processorToStagingConfig.txt";
