package Test::Hardware::TestHardware6;
...
#test sub
############
#Test case: Change Hardware for a given Hardware Lpar within different customer where the new Hardware has status of HWCOUNT should close alert
 sub test_ChangeLparHWId : Test(2) {
	my $self = shift;
	
	my $stagingHWLparId = 178384;	
	my $oldLparHWId = 164617;
	my $newLparHWId = 548361;	
