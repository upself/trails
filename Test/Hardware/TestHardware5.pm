package Test::Hardware::TestHardware5;
...
#test sub
############
#Test case: Change Hardware for a given Hardware Lpar within same customer where the new Hardware has status of INACTIVE should close alert
sub test_ChangeLparHWId : Test(2) {
	my $self = shift;
	
	my $stagingHWLparId = 443626;	
	my $oldLparHWId = 501703;
	my $newLparHWId = 467391;	
