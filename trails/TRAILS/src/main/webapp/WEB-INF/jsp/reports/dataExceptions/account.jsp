...
<display:table name="data.list" class="basic-table"
	...
	summary="DataExceptions summary by account"
	...
	<display:column property="account.account" title="Account #"
		href="/TRAILS/account/home.htm" paramId="accountId" paramProperty="account.id"
		group="1" media="html" />
	<display:column property="account.account" title="Account #" media="excel" />
	<display:column property="account.name" title="Account" group="1" media="html" />
