...
###Globals
my $logfile =
  "/var/staging/logs/softwareDoranaToStaging/softwareDoranaToStaging.log";
my $pidFile             = "/tmp/softwareDoranaToStaging.pid";
my $configFile          = "/opt/staging/v2/config/softwareDoranaToStagingConfig.txt";
