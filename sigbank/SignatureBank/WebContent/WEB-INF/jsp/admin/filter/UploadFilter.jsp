...
<h1>Software Filter Upload</h1>
<br>
<p>Utilize this loader to load software filters. The template can be
downloaded by way of the templates link on the left navigation.</p>
...
<html:form action="/UploadFilterSave" enctype="multipart/form-data">
